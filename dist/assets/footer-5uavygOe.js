class r extends HTMLElement{connectedCallback(){this.renderNavbar(),this.renderAuthControls()}renderNavbar(){this.innerHTML=`
      <style>
    ...
    `;const i=this.querySelector("#hamburger"),t=this.querySelector("#sideMenu"),e=this.querySelector("#overlay"),n=()=>{t.classList.remove("open"),e.classList.remove("show")};i.addEventListener("click",()=>{const o=t.classList.toggle("open");e.classList.toggle("show",o)}),e.addEventListener("click",n)}renderAuthControls(){}}customElements.define("site-navbar",r);class s extends HTMLElement{connectedCallback(){this.innerHTML=`
      <footer>
