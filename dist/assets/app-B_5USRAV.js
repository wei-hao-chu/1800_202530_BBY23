 ...
 */function mI(n){n=vs(n,_e);const e=vs(n.firestore,Mc);return Zw(mp(e),n._key).then(t=>EI(e,n,t))}ms._jsonSchemaVersion="firestore/querySnapshot/1.0",ms._jsonSchema={type:ue("string",ms._jsonSchemaVersion),bundleSource:ue("string","QuerySnapshot"),bundleName:ue("string"),bundle:ue("string")};class gI extends dI{constructor(e){super(),this.firestore=e}convertBytes(e){return new je(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new _e(this.firestore,null,t)}}function _I(n,e,t){n=vs(n,_e);const r=vs(n.firestore,Mc),s=fI(n.converter,e);return yI(r,[aI(oI(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,Et.none())])}function yI(n,e){return function(r,s){const i=new Qt;return r.asyncQueue.enqueueAndForget(async()=>Uw(await Xw(r),s,i)),i.promise}(mp(n),e)}function EI(n,e,t){const r=t.docs.get(e._key),s=new gI(n);return new Tn(n,s,e._key,r,new cs(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(s){Cr=s})(br),lr(new An("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new Mc(new tv(r.getProvider("auth-internal")),new sv(a,r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new M(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Is(d.options.projectId,f)}(a,s),a);return i={useFetchStreams:t,...i},c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),Gt(Su,Cu,e),Gt(Su,Cu,"esm2020")})();console.log("firebaseConfig.js loaded");const bp={apiKey:"AIzaSyBCm2OFGfOrDClvBqcZUGVl_czSw7j1Ay0",authDomain:"bby-23-pathfinder.firebaseapp.com",projectId:"bby-23-pathfinder",appId:"1:507874673807:web:e99bf3b4c164dbca9e9cfa"};console.table(bp);const Sp=dd(bp),Uc=XE(Sp),Cp=tI(Sp);console.log("authentication.js loaded");async function IR(n,e){return Ly(Uc,n,e)}async function AR(n,e,t){const s=(await Vy(Uc,e,t)).user;await xy(s,{displayName:n});try{await _I(pp(Cp,"users",s.uid),{name:n,email:e,country:"Canada",school:"BCIT",career:""}),console.log("Firestore user document created successfully!")}catch(i){console.error("Error creating Firestore document:",i)}return s}function vI(n){return $y(Uc,n)}function bR(n){const e=(n?.code||"").toLowerCase();return{"auth/invalid-credential":"Wrong email or password.","auth/invalid-email":"Please enter a valid email.","auth/user-not-found":"No account found.","auth/wrong-password":"Incorrect password.","auth/too-many-requests":"Too many attempts. Try again later.","auth/email-already-in-use":"Email already exists.","auth/weak-password":"Password too weak (min 6 chars).","auth/missing-password":"Password cannot be empty.","auth/network-request-failed":"Network error. Try again."}[e]||"Something went wrong. Please try again."}class TI extends HTMLElement{connectedCallback(){this.innerHTML=`
    ...
    `}}customElements.define("site-footer",TI);class wI extends HTMLElement{connectedCallback(){this.renderNavbar(),this.renderAuthControls()}renderNavbar(){this.innerHTML=`
      <style>
    ...
    `;const e=this.querySelector("#hamburger"),t=this.querySelector("#sideMenu"),r=this.querySelector("#overlay"),s=()=>{t.classList.remove("open"),r.classList.remove("show")};e.addEventListener("click",()=>{const i=t.classList.toggle("open");r.classList.toggle("show",i)}),r.addEventListener("click",s)}renderAuthControls(){}}customElements.define("site-navbar",wI);var Re="top",Le="bottom",Me="right",Pe="left",Eo="auto",Dr=[Re,Le,Me,Pe],Pn="start",_r="end",Rp="clippingParents",$c="viewport",er="popper",Pp="reference",qa=Dr.reduce(function(n,e){return n.concat([e+"-"+Pn,e+"-"+_r])},[]),Bc=[].concat(Dr,[Eo]).reduce(function(n,e){return n.concat([e,e+"-"+Pn,e+"-"+_r])},[]),Np="beforeRead",Dp="read",Op="afterRead",kp="beforeMain",Vp="main",Lp="afterMain",Mp="beforeWrite",xp="write",Fp="afterWrite",Up=[Np,Dp,Op,kp,Vp,Lp,Mp,xp,Fp];function dt(n){return n?(n.nodeName||"").toLowerCase():null}function xe(n){if(n==null)return window;if(n.toString()!=="[object Window]"){var e=n.ownerDocument;return e&&e.defaultView||window}return n}function Nn(n){var e=xe(n).Element;return n instanceof e||n instanceof Element}function He(n){var e=xe(n).HTMLElement;return n instanceof e||n instanceof HTMLElement}function jc(n){if(typeof ShadowRoot>"u")return!1;var e=xe(n).ShadowRoot;return n instanceof e||n instanceof ShadowRoot}function II(n){var e=n.state;Object.keys(e.elements).forEach(function(t){var r=e.styles[t]||{},s=e.attributes[t]||{},i=e.elements[t];!He(i)||!dt(i)||(Object.assign(i.style,r),Object.keys(s).forEach(function(a){var c=s[a];c===!1?i.removeAttribute(a):i.setAttribute(a,c===!0?"":c)}))})}function AI(n){var e=n.state,t={popper:{position:e.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(e.elements.popper.style,t.popper),e.styles=t,e.elements.arrow&&Object.assign(e.elements.arrow.style,t.arrow),function(){Object.keys(e.elements).forEach(function(r){var s=e.elements[r],i=e.attributes[r]||{},a=Object.keys(e.styles.hasOwnProperty(r)?e.styles[r]:t[r]),c=a.reduce(function(u,d){return u[d]="",u},{});!He(s)||!dt(s)||(Object.assign(s.style,c),Object.keys(i).forEach(function(u){s.removeAttribute(u)}))})}}const Hc={name:"applyStyles",enabled:!0,phase:"write",fn:II,effect:AI,requires:["computeStyles"]};function ct(n){return n.split("-")[0]}var wn=Math.max,Ji=Math.min,yr=Math.round;function Wa(){var n=navigator.userAgentData;return n!=null&&n.brands&&Array.isArray(n.brands)?n.brands.map(function(e){return e.brand+"/"+e.version}).join(" "):navigator.userAgent}function $p(){return!/^((?!chrome|android).)*safari/i.test(Wa())}function Er(n,e,t){e===void 0&&(e=!1),t===void 0&&(t=!1);var r=n.getBoundingClientRect(),s=1,i=1;e&&He(n)&&(s=n.offsetWidth>0&&yr(r.width)/n.offsetWidth||1,i=n.offsetHeight>0&&yr(r.height)/n.offsetHeight||1);var a=Nn(n)?xe(n):window,c=a.visualViewport,u=!$p()&&t,d=(r.left+(u&&c?c.offsetLeft:0))/s,f=(r.top+(u&&c?c.offsetTop:0))/i,y=r.width/s,w=r.height/i;return{width:y,height:w,top:f,right:d+y,bottom:f+w,left:d,x:d,y:f}}function qc(n){var e=Er(n),t=n.offsetWidth,r=n.offsetHeight;return Math.abs(e.width-t)<=1&&(t=e.width),Math.abs(e.height-r)<=1&&(r=e.height),{x:n.offsetLeft,y:n.offsetTop,width:t,height:r}}function Bp(n,e){var t=e.getRootNode&&e.getRootNode();if(n.contains(e))return!0;if(t&&jc(t)){var r=e;do{if(r&&n.isSameNode(r))return!0;r=r.parentNode||r.host}while(r)}return!1}function St(n){return xe(n).getComputedStyle(n)}function bI(n){return["table","td","th"].indexOf(dt(n))>=0}function cn(n){return((Nn(n)?n.ownerDocument:n.document)||window.document).documentElement}function vo(n){return dt(n)==="html"?n:n.assignedSlot||n.parentNode||(jc(n)?n.host:null)||cn(n)}function vh(n){return!He(n)||St(n).position==="fixed"?null:n.offsetParent}function SI(n){var e=/firefox/i.test(Wa()),t=/Trident/i.test(Wa());if(t&&He(n)){var r=St(n);if(r.position==="fixed")return null}var s=vo(n);for(jc(s)&&(s=s.host);He(s)&&["html","body"].indexOf(dt(s))<0;){var i=St(s);if(i.transform!=="none"||i.perspective!=="none"||i.contain==="paint"||["transform","perspective"].indexOf(i.willChange)!==-1||e&&i.willChange==="filter"||e&&i.filter&&i.filter!=="none")return s;s=s.parentNode}return null}function $s(n){for(var e=xe(n),t=vh(n);t&&bI(t)&&St(t).position==="static";)t=vh(t);return t&&(dt(t)==="html"||dt(t)==="body"&&St(t).position==="static")?e:t||SI(n)||e}function Wc(n){return["top","bottom"].indexOf(n)>=0?"x":"y"}function gs(n,e,t){return wn(n,Ji(e,t))}function CI(n,e,t){var r=gs(n,e,t);return r>t?t:r}function jp(){return{top:0,right:0,bottom:0,left:0}}function Hp(n){return Object.assign({},jp(),n)}function qp(n,e){return e.reduce(function(t,r){return t[r]=n,t},{})}var RI=function(e,t){return e=typeof e=="function"?e(Object.assign({},t.rects,{placement:t.placement})):e,Hp(typeof e!="number"?e:qp(e,Dr))};function PI(n){var e,t=n.state,r=n.name,s=n.options,i=t.elements.arrow,a=t.modifiersData.popperOffsets,c=ct(t.placement),u=Wc(c),d=[Pe,Me].indexOf(c)>=0,f=d?"height":"width";if(!(!i||!a)){var y=RI(s.padding,t),w=qc(i),b=u==="y"?Re:Pe,O=u==="y"?Le:Me,D=t.rects.reference[f]+t.rects.reference[u]-a[u]-t.rects.popper[f],R=a[u]-t.rects.reference[u],L=$s(i),x=L?u==="y"?L.clientHeight||0:L.clientWidth||0:0,U=D/2-R/2,$=y[b],K=x-w[f]-y[O],q=x/2-w[f]/2+U,v=gs($,q,K),m=u;t.modifiersData[r]=(e={},e[m]=v,e.centerOffset=v-q,e)}}function NI(n){var e=n.state,t=n.options,r=t.element,s=r===void 0?"[data-popper-arrow]":r;s!=null&&(typeof s=="string"&&(s=e.elements.popper.querySelector(s),!s)||Bp(e.elements.popper,s)&&(e.elements.arrow=s))}const Wp={name:"arrow",enabled:!0,phase:"main",fn:PI,effect:NI,requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function vr(n){return n.split("-")[1]}var DI={top:"auto",right:"auto",bottom:"auto",left:"auto"};function OI(n,e){var t=n.x,r=n.y,s=e.devicePixelRatio||1;return{x:yr(t*s)/s||0,y:yr(r*s)/s||0}}function Th(n){var e,t=n.popper,r=n.popperRect,s=n.placement,i=n.variation,a=n.offsets,c=n.position,u=n.gpuAcceleration,d=n.adaptive,f=n.roundOffsets,y=n.isFixed,w=a.x,b=w===void 0?0:w,O=a.y,D=O===void 0?0:O,R=typeof f=="function"?f({x:b,y:D}):{x:b,y:D};b=R.x,D=R.y;var L=a.hasOwnProperty("x"),x=a.hasOwnProperty("y"),U=Pe,$=Re,K=window;if(d){var q=$s(t),v="clientHeight",m="clientWidth";if(q===xe(t)&&(q=cn(t),St(q).position!=="static"&&c==="absolute"&&(v="scrollHeight",m="scrollWidth")),q=q,s===Re||(s===Pe||s===Me)&&i===_r){$=Le;var _=y&&q===K&&K.visualViewport?K.visualViewport.height:q[v];D-=_-r.height,D*=u?1:-1}if(s===Pe||(s===Re||s===Le)&&i===_r){U=Me;var T=y&&q===K&&K.visualViewport?K.visualViewport.width:q[m];b-=T-r.width,b*=u?1:-1}}var E=Object.assign({position:c},d&&DI),I=f===!0?OI({x:b,y:D},xe(t)):{x:b,y:D};if(b=I.x,D=I.y,u){var g;return Object.assign({},E,(g={},g[$]=x?"0":"",g[U]=L?"0":"",g.transform=(K.devicePixelRatio||1)<=1?"translate("+b+"px, "+D+"px)":"translate3d("+b+"px, "+D+"px, 0)",g))}return Object.assign({},E,(e={},e[$]=x?D+"px":"",e[U]=L?b+"px":"",e.transform="",e))}function kI(n){var e=n.state,t=n.options,r=t.gpuAcceleration,s=r===void 0?!0:r,i=t.adaptive,a=i===void 0?!0:i,c=t.roundOffsets,u=c===void 0?!0:c,d={placement:ct(e.placement),variation:vr(e.placement),popper:e.elements.popper,popperRect:e.rects.popper,gpuAcceleration:s,isFixed:e.options.strategy==="fixed"};e.modifiersData.popperOffsets!=null&&(e.styles.popper=Object.assign({},e.styles.popper,Th(Object.assign({},d,{offsets:e.modifiersData.popperOffsets,position:e.options.strategy,adaptive:a,roundOffsets:u})))),e.modifiersData.arrow!=null&&(e.styles.arrow=Object.assign({},e.styles.arrow,Th(Object.assign({},d,{offsets:e.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:u})))),e.attributes.popper=Object.assign({},e.attributes.popper,{"data-popper-placement":e.placement})}const zc={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:kI,data:{}};var di={passive:!0};function VI(n){var e=n.state,t=n.instance,r=n.options,s=r.scroll,i=s===void 0?!0:s,a=r.resize,c=a===void 0?!0:a,u=xe(e.elements.popper),d=[].concat(e.scrollParents.reference,e.scrollParents.popper);return i&&d.forEach(function(f){f.addEventListener("scroll",t.update,di)}),c&&u.addEventListener("resize",t.update,di),function(){i&&d.forEach(function(f){f.removeEventListener("scroll",t.update,di)}),c&&u.removeEventListener("resize",t.update,di)}}const Kc={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:VI,data:{}};var LI={left:"right",right:"left",bottom:"top",top:"bottom"};function Pi(n){return n.replace(/left|right|bottom|top/g,function(e){return LI[e]})}var MI={start:"end",end:"start"};function wh(n){return n.replace(/start|end/g,function(e){return MI[e]})}function Gc(n){var e=xe(n),t=e.pageXOffset,r=e.pageYOffset;return{scrollLeft:t,scrollTop:r}}function Yc(n){return Er(cn(n)).left+Gc(n).scrollLeft}function xI(n,e){var t=xe(n),r=cn(n),s=t.visualViewport,i=r.clientWidth,a=r.clientHeight,c=0,u=0;if(s){i=s.width,a=s.height;var d=$p();(d||!d&&e==="fixed")&&(c=s.offsetLeft,u=s.offsetTop)}return{width:i,height:a,x:c+Yc(n),y:u}}function FI(n){var e,t=cn(n),r=Gc(n),s=(e=n.ownerDocument)==null?void 0:e.body,i=wn(t.scrollWidth,t.clientWidth,s?s.scrollWidth:0,s?s.clientWidth:0),a=wn(t.scrollHeight,t.clientHeight,s?s.scrollHeight:0,s?s.clientHeight:0),c=-r.scrollLeft+Yc(n),u=-r.scrollTop;return St(s||t).direction==="rtl"&&(c+=wn(t.clientWidth,s?s.clientWidth:0)-i),{width:i,height:a,x:c,y:u}}function Qc(n){var e=St(n),t=e.overflow,r=e.overflowX,s=e.overflowY;return/auto|scroll|overlay|hidden/.test(t+s+r)}function zp(n){return["html","body","#document"].indexOf(dt(n))>=0?n.ownerDocument.body:He(n)&&Qc(n)?n:zp(vo(n))}function _s(n,e){var t;e===void 0&&(e=[]);var r=zp(n),s=r===((t=n.ownerDocument)==null?void 0:t.body),i=xe(r),a=s?[i].concat(i.visualViewport||[],Qc(r)?r:[]):r,c=e.concat(a);return s?c:c.concat(_s(vo(a)))}function za(n){return Object.assign({},n,{left:n.x,top:n.y,right:n.x+n.width,bottom:n.y+n.height})}function UI(n,e){var t=Er(n,!1,e==="fixed");return t.top=t.top+n.clientTop,t.left=t.left+n.clientLeft,t.bottom=t.top+n.clientHeight,t.right=t.left+n.clientWidth,t.width=n.clientWidth,t.height=n.clientHeight,t.x=t.left,t.y=t.top,t}function Ih(n,e,t){return e===$c?za(xI(n,t)):Nn(e)?UI(e,t):za(FI(cn(n)))}function $I(n){var e=_s(vo(n)),t=["absolute","fixed"].indexOf(St(n).position)>=0,r=t&&He(n)?$s(n):n;return Nn(r)?e.filter(function(s){return Nn(s)&&Bp(s,r)&&dt(s)!=="body"}):[]}function BI(n,e,t,r){var s=e==="clippingParents"?$I(n):[].concat(e),i=[].concat(s,[t]),a=i[0],c=i.reduce(function(u,d){var f=Ih(n,d,r);return u.top=wn(f.top,u.top),u.right=Ji(f.right,u.right),u.bottom=Ji(f.bottom,u.bottom),u.left=wn(f.left,u.left),u},Ih(n,a,r));return c.width=c.right-c.left,c.height=c.bottom-c.top,c.x=c.left,c.y=c.top,c}function Kp(n){var e=n.reference,t=n.element,r=n.placement,s=r?ct(r):null,i=r?vr(r):null,a=e.x+e.width/2-t.width/2,c=e.y+e.height/2-t.height/2,u;switch(s){case Re:u={x:a,y:e.y-t.height};break;case Le:u={x:a,y:e.y+e.height};break;case Me:u={x:e.x+e.width,y:c};break;case Pe:u={x:e.x-t.width,y:c};break;default:u={x:e.x,y:e.y}}var d=s?Wc(s):null;if(d!=null){var f=d==="y"?"height":"width";switch(i){case Pn:u[d]=u[d]-(e[f]/2-t[f]/2);break;case _r:u[d]=u[d]+(e[f]/2-t[f]/2);break}}return u}function Tr(n,e){e===void 0&&(e={});var t=e,r=t.placement,s=r===void 0?n.placement:r,i=t.strategy,a=i===void 0?n.strategy:i,c=t.boundary,u=c===void 0?Rp:c,d=t.rootBoundary,f=d===void 0?$c:d,y=t.elementContext,w=y===void 0?er:y,b=t.altBoundary,O=b===void 0?!1:b,D=t.padding,R=D===void 0?0:D,L=Hp(typeof R!="number"?R:qp(R,Dr)),x=w===er?Pp:er,U=n.rects.popper,$=n.elements[O?x:w],K=BI(Nn($)?$:$.contextElement||cn(n.elements.popper),u,f,a),q=Er(n.elements.reference),v=Kp({reference:q,element:U,placement:s}),m=za(Object.assign({},U,v)),_=w===er?m:q,T={top:K.top-_.top+L.top,bottom:_.bottom-K.bottom+L.bottom,left:K.left-_.left+L.left,right:_.right-K.right+L.right},E=n.modifiersData.offset;if(w===er&&E){var I=E[s];Object.keys(T).forEach(function(g){var oe=[Me,Le].indexOf(g)>=0?1:-1,be=[Re,Le].indexOf(g)>=0?"y":"x";T[g]+=I[be]*oe})}return T}function jI(n,e){e===void 0&&(e={});var t=e,r=t.placement,s=t.boundary,i=t.rootBoundary,a=t.padding,c=t.flipVariations,u=t.allowedAutoPlacements,d=u===void 0?Bc:u,f=vr(r),y=f?c?qa:qa.filter(function(O){return vr(O)===f}):Dr,w=y.filter(function(O){return d.indexOf(O)>=0});w.length===0&&(w=y);var b=w.reduce(function(O,D){return O[D]=Tr(n,{placement:D,boundary:s,rootBoundary:i,padding:a})[ct(D)],O},{});return Object.keys(b).sort(function(O,D){return b[O]-b[D]})}function HI(n){if(ct(n)===Eo)return[];var e=Pi(n);return[wh(n),e,wh(e)]}function qI(n){var e=n.state,t=n.options,r=n.name;if(!e.modifiersData[r]._skip){for(var s=t.mainAxis,i=s===void 0?!0:s,a=t.altAxis,c=a===void 0?!0:a,u=t.fallbackPlacements,d=t.padding,f=t.boundary,y=t.rootBoundary,w=t.altBoundary,b=t.flipVariations,O=b===void 0?!0:b,D=t.allowedAutoPlacements,R=e.options.placement,L=ct(R),x=L===R,U=u||(x||!O?[Pi(R)]:HI(R)),$=[R].concat(U).reduce(function(Ke,Ue){return Ke.concat(ct(Ue)===Eo?jI(e,{placement:Ue,boundary:f,rootBoundary:y,padding:d,flipVariations:O,allowedAutoPlacements:D}):Ue)},[]),K=e.rects.reference,q=e.rects.popper,v=new Map,m=!0,_=$[0],T=0;T<$.length;T++){var E=$[T],I=ct(E),g=vr(E)===Pn,oe=[Re,Le].indexOf(I)>=0,be=oe?"width":"height",Se=Tr(e,{placement:E,boundary:f,rootBoundary:y,altBoundary:w,padding:d}),Oe=oe?g?Me:Pe:g?Le:Re;K[be]>q[be]&&(Oe=Pi(Oe));var ft=Pi(Oe),Fe=[];if(i&&Fe.push(Se[I]<=0),c&&Fe.push(Se[Oe]<=0,Se[ft]<=0),Fe.every(function(Ke){return Ke})){_=E,m=!1;break}v.set(E,Fe)}if(m)for(var Fn=O?3:1,Un=function(Ue){var pt=$.find(function(Dt){var Ge=v.get(Dt);if(Ge)return Ge.slice(0,Ue).every(function($n){return $n})});if(pt)return _=pt,"break"},Nt=Fn;Nt>0;Nt--){var hn=Un(Nt);if(hn==="break")break}e.placement!==_&&(e.modifiersData[r]._skip=!0,e.placement=_,e.reset=!0)}}const Gp={name:"flip",enabled:!0,phase:"main",fn:qI,requiresIfExists:["offset"],data:{_skip:!1}};function Ah(n,e,t){return t===void 0&&(t={x:0,y:0}),{top:n.top-e.height-t.y,right:n.right-e.width+t.x,bottom:n.bottom-e.height+t.y,left:n.left-e.width-t.x}}function bh(n){return[Re,Me,Le,Pe].some(function(e){return n[e]>=0})}function WI(n){var e=n.state,t=n.name,r=e.rects.reference,s=e.rects.popper,i=e.modifiersData.preventOverflow,a=Tr(e,{elementContext:"reference"}),c=Tr(e,{altBoundary:!0}),u=Ah(a,r),d=Ah(c,s,i),f=bh(u),y=bh(d);e.modifiersData[t]={referenceClippingOffsets:u,popperEscapeOffsets:d,isReferenceHidden:f,hasPopperEscaped:y},e.attributes.popper=Object.assign({},e.attributes.popper,{"data-popper-reference-hidden":f,"data-popper-escaped":y})}const Yp={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:WI};function zI(n,e,t){var r=ct(n),s=[Pe,Re].indexOf(r)>=0?-1:1,i=typeof t=="function"?t(Object.assign({},e,{placement:n})):t,a=i[0],c=i[1];return a=a||0,c=(c||0)*s,[Pe,Me].indexOf(r)>=0?{x:c,y:a}:{x:a,y:c}}function KI(n){var e=n.state,t=n.options,r=n.name,s=t.offset,i=s===void 0?[0,0]:s,a=Bc.reduce(function(f,y){return f[y]=zI(y,e.rects,i),f},{}),c=a[e.placement],u=c.x,d=c.y;e.modifiersData.popperOffsets!=null&&(e.modifiersData.popperOffsets.x+=u,e.modifiersData.popperOffsets.y+=d),e.modifiersData[r]=a}const Qp={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:KI};function GI(n){var e=n.state,t=n.name;e.modifiersData[t]=Kp({reference:e.rects.reference,element:e.rects.popper,placement:e.placement})}const Xc={name:"popperOffsets",enabled:!0,phase:"read",fn:GI,data:{}};function YI(n){return n==="x"?"y":"x"}function QI(n){var e=n.state,t=n.options,r=n.name,s=t.mainAxis,i=s===void 0?!0:s,a=t.altAxis,c=a===void 0?!1:a,u=t.boundary,d=t.rootBoundary,f=t.altBoundary,y=t.padding,w=t.tether,b=w===void 0?!0:w,O=t.tetherOffset,D=O===void 0?0:O,R=Tr(e,{boundary:u,rootBoundary:d,padding:y,altBoundary:f}),L=ct(e.placement),x=vr(e.placement),U=!x,$=Wc(L),K=YI($),q=e.modifiersData.popperOffsets,v=e.rects.reference,m=e.rects.popper,_=typeof D=="function"?D(Object.assign({},e.rects,{placement:e.placement})):D,T=typeof _=="number"?{mainAxis:_,altAxis:_}:Object.assign({mainAxis:0,altAxis:0},_),E=e.modifiersData.offset?e.modifiersData.offset[e.placement]:null,I={x:0,y:0};if(q){if(i){var g,oe=$==="y"?Re:Pe,be=$==="y"?Le:Me,Se=$==="y"?"height":"width",Oe=q[$],ft=Oe+R[oe],Fe=Oe-R[be],Fn=b?-m[Se]/2:0,Un=x===Pn?v[Se]:m[Se],Nt=x===Pn?-m[Se]:-v[Se],hn=e.elements.arrow,Ke=b&&hn?qc(hn):{width:0,height:0},Ue=e.modifiersData["arrow#persistent"]?e.modifiersData["arrow#persistent"].padding:jp(),pt=Ue[oe],Dt=Ue[be],Ge=gs(0,v[Se],Ke[Se]),$n=U?v[Se]/2-Fn-Ge-pt-T.mainAxis:Un-Ge-pt-T.mainAxis,Co=U?-v[Se]/2+Fn+Ge+Dt+T.mainAxis:Nt+Ge+Dt+T.mainAxis,Lr=e.elements.arrow&&$s(e.elements.arrow),Ws=Lr?$==="y"?Lr.clientTop||0:Lr.clientLeft||0:0,Bn=(g=E?.[$])!=null?g:0,zs=Oe+$n-Bn-Ws,Ro=Oe+Co-Bn,jn=gs(b?Ji(ft,zs):ft,Oe,b?wn(Fe,Ro):Fe);q[$]=jn,I[$]=jn-Oe}if(c){var Hn,Ks=$==="x"?Re:Pe,pe=$==="x"?Le:Me,re=q[K],mt=K==="y"?"height":"width",Gs=re+R[Ks],Mr=re-R[pe],xr=[Re,Pe].indexOf(L)!==-1,Ot=(Hn=E?.[K])!=null?Hn:0,Fr=xr?Gs:re-v[mt]-m[mt]-Ot+T.altAxis,Ur=xr?re+v[mt]+m[mt]-Ot-T.altAxis:Mr,qn=b&&xr?CI(Fr,re,Ur):gs(b?Fr:Gs,re,b?Ur:Mr);q[K]=qn,I[K]=qn-re}e.modifiersData[r]=I}}const Xp={name:"preventOverflow",enabled:!0,phase:"main",fn:QI,requiresIfExists:["offset"]};function XI(n){return{scrollLeft:n.scrollLeft,scrollTop:n.scrollTop}}function JI(n){return n===xe(n)||!He(n)?Gc(n):XI(n)}function ZI(n){var e=n.getBoundingClientRect(),t=yr(e.width)/n.offsetWidth||1,r=yr(e.height)/n.offsetHeight||1;return t!==1||r!==1}function eA(n,e,t){t===void 0&&(t=!1);var r=He(e),s=He(e)&&ZI(e),i=cn(e),a=Er(n,s,t),c={scrollLeft:0,scrollTop:0},u={x:0,y:0};return(r||!r&&!t)&&((dt(e)!=="body"||Qc(i))&&(c=JI(e)),He(e)?(u=Er(e,!0),u.x+=e.clientLeft,u.y+=e.clientTop):i&&(u.x=Yc(i))),{x:a.left+c.scrollLeft-u.x,y:a.top+c.scrollTop-u.y,width:a.width,height:a.height}}function tA(n){var e=new Map,t=new Set,r=[];n.forEach(function(i){e.set(i.name,i)});function s(i){t.add(i.name);var a=[].concat(i.requires||[],i.requiresIfExists||[]);a.forEach(function(c){if(!t.has(c)){var u=e.get(c);u&&s(u)}}),r.push(i)}return n.forEach(function(i){t.has(i.name)||s(i)}),r}function nA(n){var e=tA(n);return Up.reduce(function(t,r){return t.concat(e.filter(function(s){return s.phase===r}))},[])}function rA(n){var e;return function(){return e||(e=new Promise(function(t){Promise.resolve().then(function(){e=void 0,t(n())})})),e}}function sA(n){var e=n.reduce(function(t,r){var s=t[r.name];return t[r.name]=s?Object.assign({},s,r,{options:Object.assign({},s.options,r.options),data:Object.assign({},s.data,r.data)}):r,t},{});return Object.keys(e).map(function(t){return e[t]})}var Sh={placement:"bottom",modifiers:[],strategy:"absolute"};function Ch(){for(var n=arguments.length,e=new Array(n),t=0;t<n;t++)e[t]=arguments[t];return!e.some(function(r){return!(r&&typeof r.getBoundingClientRect=="function")})}function To(n){n===void 0&&(n={});var e=n,t=e.defaultModifiers,r=t===void 0?[]:t,s=e.defaultOptions,i=s===void 0?Sh:s;return function(c,u,d){d===void 0&&(d=i);var f={placement:"bottom",orderedModifiers:[],options:Object.assign({},Sh,i),modifiersData:{},elements:{reference:c,popper:u},attributes:{},styles:{}},y=[],w=!1,b={state:f,setOptions:function(L){var x=typeof L=="function"?L(f.options):L;D(),f.options=Object.assign({},i,f.options,x),f.scrollParents={reference:Nn(c)?_s(c):c.contextElement?_s(c.contextElement):[],popper:_s(u)};var U=nA(sA([].concat(r,f.options.modifiers)));return f.orderedModifiers=U.filter(function($){return $.enabled}),O(),b.update()},forceUpdate:function(){if(!w){var L=f.elements,x=L.reference,U=L.popper;if(Ch(x,U)){f.rects={reference:eA(x,$s(U),f.options.strategy==="fixed"),popper:qc(U)},f.reset=!1,f.placement=f.options.placement,f.orderedModifiers.forEach(function(T){return f.modifiersData[T.name]=Object.assign({},T.data)});for(var $=0;$<f.orderedModifiers.length;$++){if(f.reset===!0){f.reset=!1,$=-1;continue}var K=f.orderedModifiers[$],q=K.fn,v=K.options,m=v===void 0?{}:v,_=K.name;typeof q=="function"&&(f=q({state:f,options:m,name:_,instance:b})||f)}}}},update:rA(function(){return new Promise(function(R){b.forceUpdate(),R(f)})}),destroy:function(){D(),w=!0}};if(!Ch(c,u))return b;b.setOptions(d).then(function(R){!w&&d.onFirstUpdate&&d.onFirstUpdate(R)});function O(){f.orderedModifiers.forEach(function(R){var L=R.name,x=R.options,U=x===void 0?{}:x,$=R.effect;if(typeof $=="function"){var K=$({state:f,name:L,instance:b,options:U}),q=function(){};y.push(K||q)}})}function D(){y.forEach(function(R){return R()}),y=[]}return b}}var iA=To(),oA=[Kc,Xc,zc,Hc],aA=To({defaultModifiers:oA}),cA=[Kc,Xc,zc,Hc,Qp,Gp,Xp,Wp,Yp],Jc=To({defaultModifiers:cA});const Jp=Object.freeze(Object.defineProperty({__proto__:null,afterMain:Lp,afterRead:Op,afterWrite:Fp,applyStyles:Hc,arrow:Wp,auto:Eo,basePlacements:Dr,beforeMain:kp,beforeRead:Np,beforeWrite:Mp,bottom:Le,clippingParents:Rp,computeStyles:zc,createPopper:Jc,createPopperBase:iA,createPopperLite:aA,detectOverflow:Tr,end:_r,eventListeners:Kc,flip:Gp,hide:Yp,left:Pe,main:Vp,modifierPhases:Up,offset:Qp,placements:Bc,popper:er,popperGenerator:To,popperOffsets:Xc,preventOverflow:Xp,read:Dp,reference:Pp,right:Me,start:Pn,top:Re,variationPlacements:qa,viewport:$c,write:xp},Symbol.toStringTag,{value:"Module"}));/*!
  * Bootstrap v5.3.8 (https://getbootstrap.com/)
  * Copyright 2011-2025 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */const $t=new Map,ra={set(n,e,t){$t.has(n)||$t.set(n,new Map);const r=$t.get(n);if(!r.has(e)&&r.size!==0){console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(r.keys())[0]}.`);return}r.set(e,t)},get(n,e){return $t.has(n)&&$t.get(n).get(e)||null},remove(n,e){if(!$t.has(n))return;const t=$t.get(n);t.delete(e),t.size===0&&$t.delete(n)}},lA=1e6,uA=1e3,Ka="transitionend",Zp=n=>(n&&window.CSS&&window.CSS.escape&&(n=n.replace(/#([^\s"#']+)/g,(e,t)=>`#${CSS.escape(t)}`)),n),hA=n=>n==null?`${n}`:Object.prototype.toString.call(n).match(/\s([a-z]+)/i)[1].toLowerCase(),dA=n=>{do n+=Math.floor(Math.random()*lA);while(document.getElementById(n));return n},fA=n=>{if(!n)return 0;let{transitionDuration:e,transitionDelay:t}=window.getComputedStyle(n);const r=Number.parseFloat(e),s=Number.parseFloat(t);return!r&&!s?0:(e=e.split(",")[0],t=t.split(",")[0],(Number.parseFloat(e)+Number.parseFloat(t))*uA)},em=n=>{n.dispatchEvent(new Event(Ka))},vt=n=>!n||typeof n!="object"?!1:(typeof n.jquery<"u"&&(n=n[0]),typeof n.nodeType<"u"),rn=n=>vt(n)?n.jquery?n[0]:n:typeof n=="string"&&n.length>0?document.querySelector(Zp(n)):null,Or=n=>{if(!vt(n)||n.getClientRects().length===0)return!1;const e=getComputedStyle(n).getPropertyValue("visibility")==="visible",t=n.closest("details:not([open])");if(!t)return e;if(t!==n){const r=n.closest("summary");if(r&&r.parentNode!==t||r===null)return!1}return e},sn=n=>!n||n.nodeType!==Node.ELEMENT_NODE||n.classList.contains("disabled")?!0:typeof n.disabled<"u"?n.disabled:n.hasAttribute("disabled")&&n.getAttribute("disabled")!=="false",tm=n=>{if(!document.documentElement.attachShadow)return null;if(typeof n.getRootNode=="function"){const e=n.getRootNode();return e instanceof ShadowRoot?e:null}return n instanceof ShadowRoot?n:n.parentNode?tm(n.parentNode):null},Zi=()=>{},Bs=n=>{n.offsetHeight},nm=()=>window.jQuery&&!document.body.hasAttribute("data-bs-no-jquery")?window.jQuery:null,sa=[],pA=n=>{document.readyState==="loading"?(sa.length||document.addEventListener("DOMContentLoaded",()=>{for(const e of sa)e()}),sa.push(n)):n()},qe=()=>document.documentElement.dir==="rtl",ze=n=>{pA(()=>{const e=nm();if(e){const t=n.NAME,r=e.fn[t];e.fn[t]=n.jQueryInterface,e.fn[t].Constructor=n,e.fn[t].noConflict=()=>(e.fn[t]=r,n.jQueryInterface)}})},De=(n,e=[],t=n)=>typeof n=="function"?n.call(...e):t,rm=(n,e,t=!0)=>{if(!t){De(n);return}const s=fA(e)+5;let i=!1;const a=({target:c})=>{c===e&&(i=!0,e.removeEventListener(Ka,a),De(n))};e.addEventListener(Ka,a),setTimeout(()=>{i||em(e)},s)},Zc=(n,e,t,r)=>{const s=n.length;let i=n.indexOf(e);return i===-1?!t&&r?n[s-1]:n[0]:(i+=t?1:-1,r&&(i=(i+s)%s),n[Math.max(0,Math.min(i,s-1))])},mA=/[^.]*(?=\..*)\.|.*/,gA=/\..*/,_A=/::\d+$/,ia={};let Rh=1;const sm={mouseenter:"mouseover",mouseleave:"mouseout"},yA=new Set(["click","dblclick","mouseup","mousedown","contextmenu","mousewheel","DOMMouseScroll","mouseover","mouseout","mousemove","selectstart","selectend","keydown","keypress","keyup","orientationchange","touchstart","touchmove","touchend","touchcancel","pointerdown","pointermove","pointerup","pointerleave","pointercancel","gesturestart","gesturechange","gestureend","focus","blur","change","reset","select","submit","focusin","focusout","load","unload","beforeunload","resize","move","DOMContentLoaded","readystatechange","error","abort","scroll"]);function im(n,e){return e&&`${e}::${Rh++}`||n.uidEvent||Rh++}function om(n){const e=im(n);return n.uidEvent=e,ia[e]=ia[e]||{},ia[e]}function EA(n,e){return function t(r){return el(r,{delegateTarget:n}),t.oneOff&&N.off(n,r.type,e),e.apply(n,[r])}}function vA(n,e,t){return function r(s){const i=n.querySelectorAll(e);for(let{target:a}=s;a&&a!==this;a=a.parentNode)for(const c of i)if(c===a)return el(s,{delegateTarget:a}),r.oneOff&&N.off(n,s.type,e,t),t.apply(a,[s])}}function am(n,e,t=null){return Object.values(n).find(r=>r.callable===e&&r.delegationSelector===t)}function cm(n,e,t){const r=typeof e=="string",s=r?t:e||t;let i=lm(n);return yA.has(i)||(i=n),[r,s,i]}function Ph(n,e,t,r,s){if(typeof e!="string"||!n)return;let[i,a,c]=cm(e,t,r);e in sm&&(a=(O=>function(D){if(!D.relatedTarget||D.relatedTarget!==D.delegateTarget&&!D.delegateTarget.contains(D.relatedTarget))return O.call(this,D)})(a));const u=om(n),d=u[c]||(u[c]={}),f=am(d,a,i?t:null);if(f){f.oneOff=f.oneOff&&s;return}const y=im(a,e.replace(mA,"")),w=i?vA(n,t,a):EA(n,a);w.delegationSelector=i?t:null,w.callable=a,w.oneOff=s,w.uidEvent=y,d[y]=w,n.addEventListener(c,w,i)}function Ga(n,e,t,r,s){const i=am(e[t],r,s);i&&(n.removeEventListener(t,i,!!s),delete e[t][i.uidEvent])}function TA(n,e,t,r){const s=e[t]||{};for(const[i,a]of Object.entries(s))i.includes(r)&&Ga(n,e,t,a.callable,a.delegationSelector)}function lm(n){return n=n.replace(gA,""),sm[n]||n}const N={on(n,e,t,r){Ph(n,e,t,r,!1)},one(n,e,t,r){Ph(n,e,t,r,!0)},off(n,e,t,r){if(typeof e!="string"||!n)return;const[s,i,a]=cm(e,t,r),c=a!==e,u=om(n),d=u[a]||{},f=e.startsWith(".");if(typeof i<"u"){if(!Object.keys(d).length)return;Ga(n,u,a,i,s?t:null);return}if(f)for(const y of Object.keys(u))TA(n,u,y,e.slice(1));for(const[y,w]of Object.entries(d)){const b=y.replace(_A,"");(!c||e.includes(b))&&Ga(n,u,a,w.callable,w.delegationSelector)}},trigger(n,e,t){if(typeof e!="string"||!n)return null;const r=nm(),s=lm(e),i=e!==s;let a=null,c=!0,u=!0,d=!1;i&&r&&(a=r.Event(e,t),r(n).trigger(a),c=!a.isPropagationStopped(),u=!a.isImmediatePropagationStopped(),d=a.isDefaultPrevented());const f=el(new Event(e,{bubbles:c,cancelable:!0}),t);return d&&f.preventDefault(),u&&n.dispatchEvent(f),f.defaultPrevented&&a&&a.preventDefault(),f}};function el(n,e={}){for(const[t,r]of Object.entries(e))try{n[t]=r}catch{Object.defineProperty(n,t,{configurable:!0,get(){return r}})}return n}function Nh(n){if(n==="true")return!0;if(n==="false")return!1;if(n===Number(n).toString())return Number(n);if(n===""||n==="null")return null;if(typeof n!="string")return n;try{return JSON.parse(decodeURIComponent(n))}catch{return n}}function oa(n){return n.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`)}const Tt={setDataAttribute(n,e,t){n.setAttribute(`data-bs-${oa(e)}`,t)},removeDataAttribute(n,e){n.removeAttribute(`data-bs-${oa(e)}`)},getDataAttributes(n){if(!n)return{};const e={},t=Object.keys(n.dataset).filter(r=>r.startsWith("bs")&&!r.startsWith("bsConfig"));for(const r of t){let s=r.replace(/^bs/,"");s=s.charAt(0).toLowerCase()+s.slice(1),e[s]=Nh(n.dataset[r])}return e},getDataAttribute(n,e){return Nh(n.getAttribute(`data-bs-${oa(e)}`))}};class js{static get Default(){return{}}static get DefaultType(){return{}}static get NAME(){throw new Error('You have to implement the static method "NAME", for each component!')}_getConfig(e){return e=this._mergeConfigObj(e),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}_configAfterMerge(e){return e}_mergeConfigObj(e,t){const r=vt(t)?Tt.getDataAttribute(t,"config"):{};return{...this.constructor.Default,...typeof r=="object"?r:{},...vt(t)?Tt.getDataAttributes(t):{},...typeof e=="object"?e:{}}}_typeCheckConfig(e,t=this.constructor.DefaultType){for(const[r,s]of Object.entries(t)){const i=e[r],a=vt(i)?"element":hA(i);if(!new RegExp(s).test(a))throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${r}" provided type "${a}" but expected type "${s}".`)}}}const wA="5.3.8";class Je extends js{constructor(e,t){super(),e=rn(e),e&&(this._element=e,this._config=this._getConfig(t),ra.set(this._element,this.constructor.DATA_KEY,this))}dispose(){ra.remove(this._element,this.constructor.DATA_KEY),N.off(this._element,this.constructor.EVENT_KEY);for(const e of Object.getOwnPropertyNames(this))this[e]=null}_queueCallback(e,t,r=!0){rm(e,t,r)}_getConfig(e){return e=this._mergeConfigObj(e,this._element),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}static getInstance(e){return ra.get(rn(e),this.DATA_KEY)}static getOrCreateInstance(e,t={}){return this.getInstance(e)||new this(e,typeof t=="object"?t:null)}static get VERSION(){return wA}static get DATA_KEY(){return`bs.${this.NAME}`}static get EVENT_KEY(){return`.${this.DATA_KEY}`}static eventName(e){return`${e}${this.EVENT_KEY}`}}const aa=n=>{let e=n.getAttribute("data-bs-target");if(!e||e==="#"){let t=n.getAttribute("href");if(!t||!t.includes("#")&&!t.startsWith("."))return null;t.includes("#")&&!t.startsWith("#")&&(t=`#${t.split("#")[1]}`),e=t&&t!=="#"?t.trim():null}return e?e.split(",").map(t=>Zp(t)).join(","):null},F={find(n,e=document.documentElement){return[].concat(...Element.prototype.querySelectorAll.call(e,n))},findOne(n,e=document.documentElement){return Element.prototype.querySelector.call(e,n)},children(n,e){return[].concat(...n.children).filter(t=>t.matches(e))},parents(n,e){const t=[];let r=n.parentNode.closest(e);for(;r;)t.push(r),r=r.parentNode.closest(e);return t},prev(n,e){let t=n.previousElementSibling;for(;t;){if(t.matches(e))return[t];t=t.previousElementSibling}return[]},next(n,e){let t=n.nextElementSibling;for(;t;){if(t.matches(e))return[t];t=t.nextElementSibling}return[]},focusableChildren(n){const e=["a","button","input","textarea","select","details","[tabindex]",'[contenteditable="true"]'].map(t=>`${t}:not([tabindex^="-"])`).join(",");return this.find(e,n).filter(t=>!sn(t)&&Or(t))},getSelectorFromElement(n){const e=aa(n);return e&&F.findOne(e)?e:null},getElementFromSelector(n){const e=aa(n);return e?F.findOne(e):null},getMultipleElementsFromSelector(n){const e=aa(n);return e?F.find(e):[]}},wo=(n,e="hide")=>{const t=`click.dismiss${n.EVENT_KEY}`,r=n.NAME;N.on(document,t,`[data-bs-dismiss="${r}"]`,function(s){if(["A","AREA"].includes(this.tagName)&&s.preventDefault(),sn(this))return;const i=F.getElementFromSelector(this)||this.closest(`.${r}`);n.getOrCreateInstance(i)[e]()})},IA="alert",AA="bs.alert",um=`.${AA}`,bA=`close${um}`,SA=`closed${um}`,CA="fade",RA="show";class Io extends Je{static get NAME(){return IA}close(){if(N.trigger(this._element,bA).defaultPrevented)return;this._element.classList.remove(RA);const t=this._element.classList.contains(CA);this._queueCallback(()=>this._destroyElement(),this._element,t)}_destroyElement(){this._element.remove(),N.trigger(this._element,SA),this.dispose()}static jQueryInterface(e){return this.each(function(){const t=Io.getOrCreateInstance(this);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e](this)}})}}wo(Io,"close");ze(Io);const PA="button",NA="bs.button",DA=`.${NA}`,OA=".data-api",kA="active",Dh='[data-bs-toggle="button"]',VA=`click${DA}${OA}`;class Ao extends Je{static get NAME(){return PA}toggle(){this._element.setAttribute("aria-pressed",this._element.classList.toggle(kA))}static jQueryInterface(e){return this.each(function(){const t=Ao.getOrCreateInstance(this);e==="toggle"&&t[e]()})}}N.on(document,VA,Dh,n=>{n.preventDefault();const e=n.target.closest(Dh);Ao.getOrCreateInstance(e).toggle()});ze(Ao);const LA="swipe",kr=".bs.swipe",MA=`touchstart${kr}`,xA=`touchmove${kr}`,FA=`touchend${kr}`,UA=`pointerdown${kr}`,$A=`pointerup${kr}`,BA="touch",jA="pen",HA="pointer-event",qA=40,WA={endCallback:null,leftCallback:null,rightCallback:null},zA={endCallback:"(function|null)",leftCallback:"(function|null)",rightCallback:"(function|null)"};class eo extends js{constructor(e,t){super(),this._element=e,!(!e||!eo.isSupported())&&(this._config=this._getConfig(t),this._deltaX=0,this._supportPointerEvents=!!window.PointerEvent,this._initEvents())}static get Default(){return WA}static get DefaultType(){return zA}static get NAME(){return LA}dispose(){N.off(this._element,kr)}_start(e){if(!this._supportPointerEvents){this._deltaX=e.touches[0].clientX;return}this._eventIsPointerPenTouch(e)&&(this._deltaX=e.clientX)}_end(e){this._eventIsPointerPenTouch(e)&&(this._deltaX=e.clientX-this._deltaX),this._handleSwipe(),De(this._config.endCallback)}_move(e){this._deltaX=e.touches&&e.touches.length>1?0:e.touches[0].clientX-this._deltaX}_handleSwipe(){const e=Math.abs(this._deltaX);if(e<=qA)return;const t=e/this._deltaX;this._deltaX=0,t&&De(t>0?this._config.rightCallback:this._config.leftCallback)}_initEvents(){this._supportPointerEvents?(N.on(this._element,UA,e=>this._start(e)),N.on(this._element,$A,e=>this._end(e)),this._element.classList.add(HA)):(N.on(this._element,MA,e=>this._start(e)),N.on(this._element,xA,e=>this._move(e)),N.on(this._element,FA,e=>this._end(e)))}_eventIsPointerPenTouch(e){return this._supportPointerEvents&&(e.pointerType===jA||e.pointerType===BA)}static isSupported(){return"ontouchstart"in document.documentElement||navigator.maxTouchPoints>0}}const KA="carousel",GA="bs.carousel",ln=`.${GA}`,hm=".data-api",YA="ArrowLeft",QA="ArrowRight",XA=500,ts="next",Gn="prev",tr="left",Ni="right",JA=`slide${ln}`,ca=`slid${ln}`,ZA=`keydown${ln}`,eb=`mouseenter${ln}`,tb=`mouseleave${ln}`,nb=`dragstart${ln}`,rb=`load${ln}${hm}`,sb=`click${ln}${hm}`,dm="carousel",fi="active",ib="slide",ob="carousel-item-end",ab="carousel-item-start",cb="carousel-item-next",lb="carousel-item-prev",fm=".active",pm=".carousel-item",ub=fm+pm,hb=".carousel-item img",db=".carousel-indicators",fb="[data-bs-slide], [data-bs-slide-to]",pb='[data-bs-ride="carousel"]',mb={[YA]:Ni,[QA]:tr},gb={interval:5e3,keyboard:!0,pause:"hover",ride:!1,touch:!0,wrap:!0},_b={interval:"(number|boolean)",keyboard:"boolean",pause:"(string|boolean)",ride:"(boolean|string)",touch:"boolean",wrap:"boolean"};class Hs extends Je{constructor(e,t){super(e,t),this._interval=null,this._activeElement=null,this._isSliding=!1,this.touchTimeout=null,this._swipeHelper=null,this._indicatorsElement=F.findOne(db,this._element),this._addEventListeners(),this._config.ride===dm&&this.cycle()}static get Default(){return gb}static get DefaultType(){return _b}static get NAME(){return KA}next(){this._slide(ts)}nextWhenVisible(){!document.hidden&&Or(this._element)&&this.next()}prev(){this._slide(Gn)}pause(){this._isSliding&&em(this._element),this._clearInterval()}cycle(){this._clearInterval(),this._updateInterval(),this._interval=setInterval(()=>this.nextWhenVisible(),this._config.interval)}_maybeEnableCycle(){if(this._config.ride){if(this._isSliding){N.one(this._element,ca,()=>this.cycle());return}this.cycle()}}to(e){const t=this._getItems();if(e>t.length-1||e<0)return;if(this._isSliding){N.one(this._element,ca,()=>this.to(e));return}const r=this._getItemIndex(this._getActive());if(r===e)return;const s=e>r?ts:Gn;this._slide(s,t[e])}dispose(){this._swipeHelper&&this._swipeHelper.dispose(),super.dispose()}_configAfterMerge(e){return e.defaultInterval=e.interval,e}_addEventListeners(){this._config.keyboard&&N.on(this._element,ZA,e=>this._keydown(e)),this._config.pause==="hover"&&(N.on(this._element,eb,()=>this.pause()),N.on(this._element,tb,()=>this._maybeEnableCycle())),this._config.touch&&eo.isSupported()&&this._addTouchEventListeners()}_addTouchEventListeners(){for(const r of F.find(hb,this._element))N.on(r,nb,s=>s.preventDefault());const t={leftCallback:()=>this._slide(this._directionToOrder(tr)),rightCallback:()=>this._slide(this._directionToOrder(Ni)),endCallback:()=>{this._config.pause==="hover"&&(this.pause(),this.touchTimeout&&clearTimeout(this.touchTimeout),this.touchTimeout=setTimeout(()=>this._maybeEnableCycle(),XA+this._config.interval))}};this._swipeHelper=new eo(this._element,t)}_keydown(e){if(/input|textarea/i.test(e.target.tagName))return;const t=mb[e.key];t&&(e.preventDefault(),this._slide(this._directionToOrder(t)))}_getItemIndex(e){return this._getItems().indexOf(e)}_setActiveIndicatorElement(e){if(!this._indicatorsElement)return;const t=F.findOne(fm,this._indicatorsElement);t.classList.remove(fi),t.removeAttribute("aria-current");const r=F.findOne(`[data-bs-slide-to="${e}"]`,this._indicatorsElement);r&&(r.classList.add(fi),r.setAttribute("aria-current","true"))}_updateInterval(){const e=this._activeElement||this._getActive();if(!e)return;const t=Number.parseInt(e.getAttribute("data-bs-interval"),10);this._config.interval=t||this._config.defaultInterval}_slide(e,t=null){if(this._isSliding)return;const r=this._getActive(),s=e===ts,i=t||Zc(this._getItems(),r,s,this._config.wrap);if(i===r)return;const a=this._getItemIndex(i),c=b=>N.trigger(this._element,b,{relatedTarget:i,direction:this._orderToDirection(e),from:this._getItemIndex(r),to:a});if(c(JA).defaultPrevented||!r||!i)return;const d=!!this._interval;this.pause(),this._isSliding=!0,this._setActiveIndicatorElement(a),this._activeElement=i;const f=s?ab:ob,y=s?cb:lb;i.classList.add(y),Bs(i),r.classList.add(f),i.classList.add(f);const w=()=>{i.classList.remove(f,y),i.classList.add(fi),r.classList.remove(fi,y,f),this._isSliding=!1,c(ca)};this._queueCallback(w,r,this._isAnimated()),d&&this.cycle()}_isAnimated(){return this._element.classList.contains(ib)}_getActive(){return F.findOne(ub,this._element)}_getItems(){return F.find(pm,this._element)}_clearInterval(){this._interval&&(clearInterval(this._interval),this._interval=null)}_directionToOrder(e){return qe()?e===tr?Gn:ts:e===tr?ts:Gn}_orderToDirection(e){return qe()?e===Gn?tr:Ni:e===Gn?Ni:tr}static jQueryInterface(e){return this.each(function(){const t=Hs.getOrCreateInstance(this,e);if(typeof e=="number"){t.to(e);return}if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e]()}})}}N.on(document,sb,fb,function(n){const e=F.getElementFromSelector(this);if(!e||!e.classList.contains(dm))return;n.preventDefault();const t=Hs.getOrCreateInstance(e),r=this.getAttribute("data-bs-slide-to");if(r){t.to(r),t._maybeEnableCycle();return}if(Tt.getDataAttribute(this,"slide")==="next"){t.next(),t._maybeEnableCycle();return}t.prev(),t._maybeEnableCycle()});N.on(window,rb,()=>{const n=F.find(pb);for(const e of n)Hs.getOrCreateInstance(e)});ze(Hs);const yb="collapse",Eb="bs.collapse",qs=`.${Eb}`,vb=".data-api",Tb=`show${qs}`,wb=`shown${qs}`,Ib=`hide${qs}`,Ab=`hidden${qs}`,bb=`click${qs}${vb}`,la="show",sr="collapse",pi="collapsing",Sb="collapsed",Cb=`:scope .${sr} .${sr}`,Rb="collapse-horizontal",Pb="width",Nb="height",Db=".collapse.show, .collapse.collapsing",Ya='[data-bs-toggle="collapse"]',Ob={parent:null,toggle:!0},kb={parent:"(null|element)",toggle:"boolean"};class Rs extends Je{constructor(e,t){super(e,t),this._isTransitioning=!1,this._triggerArray=[];const r=F.find(Ya);for(const s of r){const i=F.getSelectorFromElement(s),a=F.find(i).filter(c=>c===this._element);i!==null&&a.length&&this._triggerArray.push(s)}this._initializeChildren(),this._config.parent||this._addAriaAndCollapsedClass(this._triggerArray,this._isShown()),this._config.toggle&&this.toggle()}static get Default(){return Ob}static get DefaultType(){return kb}static get NAME(){return yb}toggle(){this._isShown()?this.hide():this.show()}show(){if(this._isTransitioning||this._isShown())return;let e=[];if(this._config.parent&&(e=this._getFirstLevelChildren(Db).filter(c=>c!==this._element).map(c=>Rs.getOrCreateInstance(c,{toggle:!1}))),e.length&&e[0]._isTransitioning||N.trigger(this._element,Tb).defaultPrevented)return;for(const c of e)c.hide();const r=this._getDimension();this._element.classList.remove(sr),this._element.classList.add(pi),this._element.style[r]=0,this._addAriaAndCollapsedClass(this._triggerArray,!0),this._isTransitioning=!0;const s=()=>{this._isTransitioning=!1,this._element.classList.remove(pi),this._element.classList.add(sr,la),this._element.style[r]="",N.trigger(this._element,wb)},a=`scroll${r[0].toUpperCase()+r.slice(1)}`;this._queueCallback(s,this._element,!0),this._element.style[r]=`${this._element[a]}px`}hide(){if(this._isTransitioning||!this._isShown()||N.trigger(this._element,Ib).defaultPrevented)return;const t=this._getDimension();this._element.style[t]=`${this._element.getBoundingClientRect()[t]}px`,Bs(this._element),this._element.classList.add(pi),this._element.classList.remove(sr,la);for(const s of this._triggerArray){const i=F.getElementFromSelector(s);i&&!this._isShown(i)&&this._addAriaAndCollapsedClass([s],!1)}this._isTransitioning=!0;const r=()=>{this._isTransitioning=!1,this._element.classList.remove(pi),this._element.classList.add(sr),N.trigger(this._element,Ab)};this._element.style[t]="",this._queueCallback(r,this._element,!0)}_isShown(e=this._element){return e.classList.contains(la)}_configAfterMerge(e){return e.toggle=!!e.toggle,e.parent=rn(e.parent),e}_getDimension(){return this._element.classList.contains(Rb)?Pb:Nb}_initializeChildren(){if(!this._config.parent)return;const e=this._getFirstLevelChildren(Ya);for(const t of e){const r=F.getElementFromSelector(t);r&&this._addAriaAndCollapsedClass([t],this._isShown(r))}}_getFirstLevelChildren(e){const t=F.find(Cb,this._config.parent);return F.find(e,this._config.parent).filter(r=>!t.includes(r))}_addAriaAndCollapsedClass(e,t){if(e.length)for(const r of e)r.classList.toggle(Sb,!t),r.setAttribute("aria-expanded",t)}static jQueryInterface(e){const t={};return typeof e=="string"&&/show|hide/.test(e)&&(t.toggle=!1),this.each(function(){const r=Rs.getOrCreateInstance(this,t);if(typeof e=="string"){if(typeof r[e]>"u")throw new TypeError(`No method named "${e}"`);r[e]()}})}}N.on(document,bb,Ya,function(n){(n.target.tagName==="A"||n.delegateTarget&&n.delegateTarget.tagName==="A")&&n.preventDefault();for(const e of F.getMultipleElementsFromSelector(this))Rs.getOrCreateInstance(e,{toggle:!1}).toggle()});ze(Rs);const Oh="dropdown",Vb="bs.dropdown",Mn=`.${Vb}`,tl=".data-api",Lb="Escape",kh="Tab",Mb="ArrowUp",Vh="ArrowDown",xb=2,Fb=`hide${Mn}`,Ub=`hidden${Mn}`,$b=`show${Mn}`,Bb=`shown${Mn}`,mm=`click${Mn}${tl}`,gm=`keydown${Mn}${tl}`,jb=`keyup${Mn}${tl}`,nr="show",Hb="dropup",qb="dropend",Wb="dropstart",zb="dropup-center",Kb="dropdown-center",En='[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',Gb=`${En}.${nr}`,Di=".dropdown-menu",Yb=".navbar",Qb=".navbar-nav",Xb=".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",Jb=qe()?"top-end":"top-start",Zb=qe()?"top-start":"top-end",eS=qe()?"bottom-end":"bottom-start",tS=qe()?"bottom-start":"bottom-end",nS=qe()?"left-start":"right-start",rS=qe()?"right-start":"left-start",sS="top",iS="bottom",oS={autoClose:!0,boundary:"clippingParents",display:"dynamic",offset:[0,2],popperConfig:null,reference:"toggle"},aS={autoClose:"(boolean|string)",boundary:"(string|element)",display:"string",offset:"(array|string|function)",popperConfig:"(null|object|function)",reference:"(string|element|object)"};class lt extends Je{constructor(e,t){super(e,t),this._popper=null,this._parent=this._element.parentNode,this._menu=F.next(this._element,Di)[0]||F.prev(this._element,Di)[0]||F.findOne(Di,this._parent),this._inNavbar=this._detectNavbar()}static get Default(){return oS}static get DefaultType(){return aS}static get NAME(){return Oh}toggle(){return this._isShown()?this.hide():this.show()}show(){if(sn(this._element)||this._isShown())return;const e={relatedTarget:this._element};if(!N.trigger(this._element,$b,e).defaultPrevented){if(this._createPopper(),"ontouchstart"in document.documentElement&&!this._parent.closest(Qb))for(const r of[].concat(...document.body.children))N.on(r,"mouseover",Zi);this._element.focus(),this._element.setAttribute("aria-expanded",!0),this._menu.classList.add(nr),this._element.classList.add(nr),N.trigger(this._element,Bb,e)}}hide(){if(sn(this._element)||!this._isShown())return;const e={relatedTarget:this._element};this._completeHide(e)}dispose(){this._popper&&this._popper.destroy(),super.dispose()}update(){this._inNavbar=this._detectNavbar(),this._popper&&this._popper.update()}_completeHide(e){if(!N.trigger(this._element,Fb,e).defaultPrevented){if("ontouchstart"in document.documentElement)for(const r of[].concat(...document.body.children))N.off(r,"mouseover",Zi);this._popper&&this._popper.destroy(),this._menu.classList.remove(nr),this._element.classList.remove(nr),this._element.setAttribute("aria-expanded","false"),Tt.removeDataAttribute(this._menu,"popper"),N.trigger(this._element,Ub,e)}}_getConfig(e){if(e=super._getConfig(e),typeof e.reference=="object"&&!vt(e.reference)&&typeof e.reference.getBoundingClientRect!="function")throw new TypeError(`${Oh.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);return e}_createPopper(){if(typeof Jp>"u")throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org/docs/v2/)");let e=this._element;this._config.reference==="parent"?e=this._parent:vt(this._config.reference)?e=rn(this._config.reference):typeof this._config.reference=="object"&&(e=this._config.reference);const t=this._getPopperConfig();this._popper=Jc(e,this._menu,t)}_isShown(){return this._menu.classList.contains(nr)}_getPlacement(){const e=this._parent;if(e.classList.contains(qb))return nS;if(e.classList.contains(Wb))return rS;if(e.classList.contains(zb))return sS;if(e.classList.contains(Kb))return iS;const t=getComputedStyle(this._menu).getPropertyValue("--bs-position").trim()==="end";return e.classList.contains(Hb)?t?Zb:Jb:t?tS:eS}_detectNavbar(){return this._element.closest(Yb)!==null}_getOffset(){const{offset:e}=this._config;return typeof e=="string"?e.split(",").map(t=>Number.parseInt(t,10)):typeof e=="function"?t=>e(t,this._element):e}_getPopperConfig(){const e={placement:this._getPlacement(),modifiers:[{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"offset",options:{offset:this._getOffset()}}]};return(this._inNavbar||this._config.display==="static")&&(Tt.setDataAttribute(this._menu,"popper","static"),e.modifiers=[{name:"applyStyles",enabled:!1}]),{...e,...De(this._config.popperConfig,[void 0,e])}}_selectMenuItem({key:e,target:t}){const r=F.find(Xb,this._menu).filter(s=>Or(s));r.length&&Zc(r,t,e===Vh,!r.includes(t)).focus()}static jQueryInterface(e){return this.each(function(){const t=lt.getOrCreateInstance(this,e);if(typeof e=="string"){if(typeof t[e]>"u")throw new TypeError(`No method named "${e}"`);t[e]()}})}static clearMenus(e){if(e.button===xb||e.type==="keyup"&&e.key!==kh)return;const t=F.find(Gb);for(const r of t){const s=lt.getInstance(r);if(!s||s._config.autoClose===!1)continue;const i=e.composedPath(),a=i.includes(s._menu);if(i.includes(s._element)||s._config.autoClose==="inside"&&!a||s._config.autoClose==="outside"&&a||s._menu.contains(e.target)&&(e.type==="keyup"&&e.key===kh||/input|select|option|textarea|form/i.test(e.target.tagName)))continue;const c={relatedTarget:s._element};e.type==="click"&&(c.clickEvent=e),s._completeHide(c)}}static dataApiKeydownHandler(e){const t=/input|textarea/i.test(e.target.tagName),r=e.key===Lb,s=[Mb,Vh].includes(e.key);if(!s&&!r||t&&!r)return;e.preventDefault();const i=this.matches(En)?this:F.prev(this,En)[0]||F.next(this,En)[0]||F.findOne(En,e.delegateTarget.parentNode),a=lt.getOrCreateInstance(i);if(s){e.stopPropagation(),a.show(),a._selectMenuItem(e);return}a._isShown()&&(e.stopPropagation(),a.hide(),i.focus())}}N.on(document,gm,En,lt.dataApiKeydownHandler);N.on(document,gm,Di,lt.dataApiKeydownHandler);N.on(document,mm,lt.clearMenus);N.on(document,jb,lt.clearMenus);N.on(document,mm,En,function(n){n.preventDefault(),lt.getOrCreateInstance(this).toggle()});ze(lt);const _m="backdrop",cS="fade",Lh="show",Mh=`mousedown.bs.${_m}`,lS={className:"modal-backdrop",clickCallback:null,isAnimated:!1,isVisible:!0,rootElement:"body"},uS={className:"string",clickCallback:"(function|null)",isAnimated:"boolean",isVisible:"boolean",rootElement:"(element|string)"};class ym extends js{constructor(e){super(),this._config=this._getConfig(e),this._isAppended=!1,this._element=null}static get Default(){return lS}static get DefaultType(){return uS}static get NAME(){return _m}show(e){if(!this._config.isVisible){De(e);return}this._append();const t=this._getElement();this._config.isAnimated&&Bs(t),t.classList.add(Lh),this._emulateAnimation(()=>{De(e)})}hide(e){if(!this._config.isVisible){De(e);return}this._getElement().classList.remove(Lh),this._emulateAnimation(()=>{this.dispose(),De(e)})}dispose(){this._isAppended&&(N.off(this._element,Mh),this._element.remove(),this._isAppended=!1)}_getElement(){if(!this._element){const e=document.createElement("div");e.className=this._config.className,this._config.isAnimated&&e.classList.add(cS),this._element=e}return this._element}_configAfterMerge(e){return e.rootElement=rn(e.rootElement),e}_append(){if(this._isAppended)return;const e=this._getElement();this._config.rootElement.append(e),N.on(e,Mh,()=>{De(this._config.clickCallback)}),this._isAppended=!0}_emulateAnimation(e){rm(e,this._getElement(),this._config.isAnimated)}}const hS="focustrap",dS="bs.focustrap",to=`.${dS}`,fS=`focusin${to}`,pS=`keydown.tab${to}`,mS="Tab",gS="forward",xh="backward",_S={autofocus:!0,trapElement:null},yS={autofocus:"boolean",trapElement:"element"};class Em extends js{constructor(e){super(),this._config=this._getConfig(e),this._isActive=!1,this._lastTabNavDirection=null}static get Default(){return _S}static get DefaultType(){return yS}static get NAME(){return hS}activate(){this._isActive||(this._config.autofocus&&this._config.trapElement.focus(),N.off(document,to),N.on(document,fS,e=>this._handleFocusin(e)),N.on(document,pS,e=>this._handleKeydown(e)),this._isActive=!0)}deactivate(){this._isActive&&(this._isActive=!1,N.off(document,to))}_handleFocusin(e){const{trapElement:t}=this._config;if(e.target===document||e.target===t||t.contains(e.target))return;const r=F.focusableChildren(t);r.length===0?t.focus():this._lastTabNavDirection===xh?r[r.length-1].focus():r[0].focus()}_handleKeydown(e){e.key===mS&&(this._lastTabNavDirection=e.shiftKey?xh:gS)}}const Fh=".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",Uh=".sticky-top",mi="padding-right",$h="margin-right";class Qa{constructor(){this._element=document.body}getWidth(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}hide(){const e=this.getWidth();this._disableOverFlow(),this._setElementAttributes(this._element,mi,t=>t+e),this._setElementAttributes(Fh,mi,t=>t+e),this._setElementAttributes(Uh,$h,t=>t-e)}reset(){this._resetElementAttributes(this._element,"overflow"),this._resetElementAttributes(this._element,mi),this._resetElementAttributes(Fh,mi),this._resetElementAttributes(Uh,$h)}isOverflowing(){return this.getWidth()>0}_disableOverFlow(){this._saveInitialAttribute(this._element,"overflow"),this._element.style.overflow="hidden"}_setElementAttributes(e,t,r){const s=this.getWidth(),i=a=>{if(a!==this._element&&window.innerWidth>a.clientWidth+s)return;this._saveInitialAttribute(a,t);const c=window.getComputedStyle(a).getPropertyValue(t);a.style.setProperty(t,`${r(Number.parseFloat(c))}px`)};this._applyManipulationCallback(e,i)}_saveInitialAttribute(e,t){const r=e.style.getPropertyValue(t);r&&Tt.setDataAttribute(e,t,r)}_resetElementAttributes(e,t){const r=s=>{const i=Tt.getDataAttribute(s,t);if(i===null){s.style.removeProperty(t);return}Tt.removeDataAttribute(s,t),s.style.setProperty(t,i)};this._applyManipulationCallback(e,r)}_applyManipulationCallback(e,t){if(vt(e)){t(e);return}for(const r of F.find(e,this._element))t(r)}}const ES="modal",vS="bs.modal",We=`.${vS}`,TS=".data-api",wS="Escape",IS=`hide${We}`,AS=`hidePrevented${We}`,vm=`hidden${We}`,Tm=`show${We}`,bS=`shown${We}`,SS=`resize${We}`,CS=`click.dismiss${We}`,RS=`mousedown.dismiss${We}`,PS=`keydown.dismiss${We}`,NS=`click${We}${TS}`,Bh="modal-open",DS="fade",jh="show",ua="modal-static",OS=".modal.show",kS=".modal-dialog",VS=".modal-body",LS='[data-bs-toggle="modal"]',MS={backdrop:!0,focus:!0,keyboard:!0},xS={backdrop:"(boolean|string)",focus:"boolean",keyboard:"boolean"};class wr extends Je{constructor(e,t){super(e,t),this._dialog=F.findOne(kS,this._element),this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._isShown=!1,this._isTransitioning=!1,this._scrollBar=new Qa,this._addEventListeners()}static get Default(){return MS}static get DefaultType(){return xS}static get NAME(){return ES}toggle(e){return this._isShown?this.hide():this.show(e)}show(e){this._isShown||this._isTransitioning||N.trigger(this._element,Tm,{relatedTarget:e}).defaultPrevented||(this._isShown=!0,this._isTransitioning=!0,this._scrollBar.hide(),document.body.classList.add(Bh),this._adjustDialog(),this._backdrop.show(()=>this._showElement(e)))}hide(){!this._isShown||this._isTransitioning||N.trigger(this._element,IS).defaultPrevented||(this._isShown=!1,this._isTransitioning=!0,this._focustrap.deactivate(),this._element.classList.remove(jh),this._queueCallback(()=>this._hideModal(),this._element,this._isAnimated()))}dispose(){N.off(window,We),N.off(this._dialog,We),this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}handleUpdate(){this._adjustDialog()}_initializeBackDrop(){return new ym({isVisible:!!this._config.backdrop,isAnimated:this._isAnimated()})}_initializeFocusTrap(){return new Em({trapElement:this._element})}_showElement(e){document.body.contains(this._element)||document.body.append(this._element),this._element.style.display="block",this._element.removeAttribute("aria-hidden"),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.scrollTop=0;const t=F.findOne(VS,this._dialog);t&&(t.scrollTop=0),Bs(this._element),this._element.classList.add(jh);const r=()=>{this._config.focus&&this._focustrap.activate(),this._isTransitioning=!1,N.trigger(this._element,bS,{relatedTarget:e})};this._queueCallback(r,this._dialog,this._isAnimated())}_addEventListeners(){N.on(this._element,PS,e=>{if(e.key===wS){if(this._config.keyboard){this.hide();return}this._triggerBackdropTransition()}}),N.on(window,SS,()=>{this._isShown&&!this._isTransitioning&&this._adjustDialog()}),N.on(this._element,RS,e=>{N.one(this._element,CS,t=>{if(!(this._element!==e.target||this._element!==t.target)){if(this._config.backdrop==="static"){this._triggerBackdropTransition();return}this._config.backdrop&&this.hide()}})})}_hideModal(){this._element.style.display="none",this._element.setAttribute("aria-hidden",!0),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._isTransitioning=!1,this._backdrop.hide(()=>{document.body.classList.remove(Bh),this._resetAdjustments(),this._scrollBar.reset(),N.trigger(this._element,vm)})}_isAnimated(){return this._element.classList.contains(DS)}_triggerBackdropTransition(){if(N.trigger(this._element,AS).defaultPrevented)return;const t=this._element.scrollHeight>document.documentElement.clientHeight,r=this._element.style.overflowY;r==="hidden"||this._element.classList.contains(ua)||(t||(this._element.style.overflowY="hidden"),this._element.classList.add(ua),this._queueCallback(()=>{this._element.classList.remove(ua),this._queueCallback(()=>{this._element.style.overflowY=r},this._dialog)},this._dialog),this._element.focus())}_adjustDialog(){const e=this._element.scrollHeight>document.documentElement.clientHeight,t=this._scrollBar.getWidth(),r=t>0;if(r&&!e){const s=qe()?"paddingLeft":"paddingRight";this._element.style[s]=`${t}px`}if(!r&&e){const s=qe()?"paddingRight":"paddingLeft";this._element.style[s]=`${t}px`}}_resetAdjustments(){this._element.style.paddingLeft="",this._element.style.paddingRight=""}static jQueryInterface(e,t){return this.each(function(){const r=wr.getOrCreateInstance(this,e);if(typeof e=="string"){if(typeof r[e]>"u")throw new TypeError(`No method named "${e}"`);r[e](t)}})}}N.on(document,NS,LS,function(n){const e=F.getElementFromSelector(this);["A","AREA"].includes(this.tagName)&&n.preventDefault(),N.one(e,Tm,s=>{s.defaultPrevented||N.one(e,vm,()=>{Or(this)&&this.focus()})});const t=F.findOne(OS);t&&wr.getInstance(t).hide(),wr.getOrCreateInstance(e).toggle(this)});wo(wr);ze(wr);const FS="offcanvas",US="bs.offcanvas",Pt=`.${US}`,wm=".data-api",$S=`load${Pt}${wm}`,BS="Escape",Hh="show",qh="showing",Wh="hiding",jS="offcanvas-backdrop",Im=".offcanvas.show",HS=`show${Pt}`,qS=`shown${Pt}`,WS=`hide${Pt}`,zh=`hidePrevented${Pt}`,Am=`hidden${Pt}`,zS=`resize${Pt}`,KS=`click${Pt}${wm}`,GS=`keydown.dismiss${Pt}`,YS='[data-bs-toggle="offcanvas"]',QS={backdrop:!0,keyboard:!0,scroll:!1},XS={backdrop:"(boolean|string)",keyboard:"boolean",scroll:"boolean"};class on extends Je{constructor(e,t){super(e,t),this._isShown=!1,this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._addEventListeners()}static get Default(){return QS}static get DefaultType(){return XS}static get NAME(){return FS}toggle(e){return this._isShown?this.hide():this.show(e)}show(e){if(this._isShown||N.trigger(this._element,HS,{relatedTarget:e}).defaultPrevented)return;this._isShown=!0,this._backdrop.show(),this._config.scroll||new Qa().hide(),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.classList.add(qh);const r=()=>{(!this._config.scroll||this._config.backdrop)&&this._focustrap.activate(),this._element.classList.add(Hh),this._element.classList.remove(qh),N.trigger(this._element,qS,{relatedTarget:e})};this._queueCallback(r,this._element,!0)}hide(){if(!this._isShown||N.trigger(this._element,WS).defaultPrevented)return;this._focustrap.deactivate(),this._element.blur(),this._isShown=!1,this._element.classList.add(Wh),this._backdrop.hide();const t=()=>{this._element.classList.remove(Hh,Wh),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._config.scroll||new Qa().reset(),N.trigger(this._element,Am)};this._queueCallback(t,this._element,!0)}dispose(){this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}_initializeBackDrop(){const e=()=>{if(this._config.backdrop==="static"){N.trigger(this._element,zh);return}this.hide()},t=!!this._config.backdrop;return new ym({className:jS,isVisible:t,isAnimated:!0,rootElement:this._element.parentNode,clickCallback:t?e:null})}_initializeFocusTrap(){return new Em({trapElement:this._element})}_addEventListeners(){N.on(this._element,GS,e=>{if(e.key===BS){if(this._config.keyboard){this.hide();return}N.trigger(this._element,zh)}})}static jQueryInterface(e){return this.each(function(){const t=on.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e](this)}})}}N.on(document,KS,YS,function(n){const e=F.getElementFromSelector(this);if(["A","AREA"].includes(this.tagName)&&n.preventDefault(),sn(this))return;N.one(e,Am,()=>{Or(this)&&this.focus()});const t=F.findOne(Im);t&&t!==e&&on.getInstance(t).hide(),on.getOrCreateInstance(e).toggle(this)});N.on(window,$S,()=>{for(const n of F.find(Im))on.getOrCreateInstance(n).show()});N.on(window,zS,()=>{for(const n of F.find("[aria-modal][class*=show][class*=offcanvas-]"))getComputedStyle(n).position!=="fixed"&&on.getOrCreateInstance(n).hide()});wo(on);ze(on);const JS=/^aria-[\w-]*$/i,bm={"*":["class","dir","id","lang","role",JS],a:["target","href","title","rel"],area:[],b:[],br:[],col:[],code:[],dd:[],div:[],dl:[],dt:[],em:[],hr:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],i:[],img:["src","srcset","alt","title","width","height"],li:[],ol:[],p:[],pre:[],s:[],small:[],span:[],sub:[],sup:[],strong:[],u:[],ul:[]},ZS=new Set(["background","cite","href","itemtype","longdesc","poster","src","xlink:href"]),eC=/^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,tC=(n,e)=>{const t=n.nodeName.toLowerCase();return e.includes(t)?ZS.has(t)?!!eC.test(n.nodeValue):!0:e.filter(r=>r instanceof RegExp).some(r=>r.test(t))};function nC(n,e,t){if(!n.length)return n;if(t&&typeof t=="function")return t(n);const s=new window.DOMParser().parseFromString(n,"text/html"),i=[].concat(...s.body.querySelectorAll("*"));for(const a of i){const c=a.nodeName.toLowerCase();if(!Object.keys(e).includes(c)){a.remove();continue}const u=[].concat(...a.attributes),d=[].concat(e["*"]||[],e[c]||[]);for(const f of u)tC(f,d)||a.removeAttribute(f.nodeName)}return s.body.innerHTML}const rC="TemplateFactory",sC={allowList:bm,content:{},extraClass:"",html:!1,sanitize:!0,sanitizeFn:null,template:"<div></div>"},iC={allowList:"object",content:"object",extraClass:"(string|function)",html:"boolean",sanitize:"boolean",sanitizeFn:"(null|function)",template:"string"},oC={entry:"(string|element|function|null)",selector:"(string|element)"};class aC extends js{constructor(e){super(),this._config=this._getConfig(e)}static get Default(){return sC}static get DefaultType(){return iC}static get NAME(){return rC}getContent(){return Object.values(this._config.content).map(e=>this._resolvePossibleFunction(e)).filter(Boolean)}hasContent(){return this.getContent().length>0}changeContent(e){return this._checkContent(e),this._config.content={...this._config.content,...e},this}toHtml(){const e=document.createElement("div");e.innerHTML=this._maybeSanitize(this._config.template);for(const[s,i]of Object.entries(this._config.content))this._setContent(e,i,s);const t=e.children[0],r=this._resolvePossibleFunction(this._config.extraClass);return r&&t.classList.add(...r.split(" ")),t}_typeCheckConfig(e){super._typeCheckConfig(e),this._checkContent(e.content)}_checkContent(e){for(const[t,r]of Object.entries(e))super._typeCheckConfig({selector:t,entry:r},oC)}_setContent(e,t,r){const s=F.findOne(r,e);if(s){if(t=this._resolvePossibleFunction(t),!t){s.remove();return}if(vt(t)){this._putElementInTemplate(rn(t),s);return}if(this._config.html){s.innerHTML=this._maybeSanitize(t);return}s.textContent=t}}_maybeSanitize(e){return this._config.sanitize?nC(e,this._config.allowList,this._config.sanitizeFn):e}_resolvePossibleFunction(e){return De(e,[void 0,this])}_putElementInTemplate(e,t){if(this._config.html){t.innerHTML="",t.append(e);return}t.textContent=e.textContent}}const cC="tooltip",lC=new Set(["sanitize","allowList","sanitizeFn"]),ha="fade",uC="modal",gi="show",hC=".tooltip-inner",Kh=`.${uC}`,Gh="hide.bs.modal",ns="hover",da="focus",fa="click",dC="manual",fC="hide",pC="hidden",mC="show",gC="shown",_C="inserted",yC="click",EC="focusin",vC="focusout",TC="mouseenter",wC="mouseleave",IC={AUTO:"auto",TOP:"top",RIGHT:qe()?"left":"right",BOTTOM:"bottom",LEFT:qe()?"right":"left"},AC={allowList:bm,animation:!0,boundary:"clippingParents",container:!1,customClass:"",delay:0,fallbackPlacements:["top","right","bottom","left"],html:!1,offset:[0,6],placement:"top",popperConfig:null,sanitize:!0,sanitizeFn:null,selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',title:"",trigger:"hover focus"},bC={allowList:"object",animation:"boolean",boundary:"(string|element)",container:"(string|element|boolean)",customClass:"(string|function)",delay:"(number|object)",fallbackPlacements:"array",html:"boolean",offset:"(array|string|function)",placement:"(string|function)",popperConfig:"(null|object|function)",sanitize:"boolean",sanitizeFn:"(null|function)",selector:"(string|boolean)",template:"string",title:"(string|element|function)",trigger:"string"};class Vr extends Je{constructor(e,t){if(typeof Jp>"u")throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org/docs/v2/)");super(e,t),this._isEnabled=!0,this._timeout=0,this._isHovered=null,this._activeTrigger={},this._popper=null,this._templateFactory=null,this._newContent=null,this.tip=null,this._setListeners(),this._config.selector||this._fixTitle()}static get Default(){return AC}static get DefaultType(){return bC}static get NAME(){return cC}enable(){this._isEnabled=!0}disable(){this._isEnabled=!1}toggleEnabled(){this._isEnabled=!this._isEnabled}toggle(){if(this._isEnabled){if(this._isShown()){this._leave();return}this._enter()}}dispose(){clearTimeout(this._timeout),N.off(this._element.closest(Kh),Gh,this._hideModalHandler),this._element.getAttribute("data-bs-original-title")&&this._element.setAttribute("title",this._element.getAttribute("data-bs-original-title")),this._disposePopper(),super.dispose()}show(){if(this._element.style.display==="none")throw new Error("Please use show on visible elements");if(!(this._isWithContent()&&this._isEnabled))return;const e=N.trigger(this._element,this.constructor.eventName(mC)),r=(tm(this._element)||this._element.ownerDocument.documentElement).contains(this._element);if(e.defaultPrevented||!r)return;this._disposePopper();const s=this._getTipElement();this._element.setAttribute("aria-describedby",s.getAttribute("id"));const{container:i}=this._config;if(this._element.ownerDocument.documentElement.contains(this.tip)||(i.append(s),N.trigger(this._element,this.constructor.eventName(_C))),this._popper=this._createPopper(s),s.classList.add(gi),"ontouchstart"in document.documentElement)for(const c of[].concat(...document.body.children))N.on(c,"mouseover",Zi);const a=()=>{N.trigger(this._element,this.constructor.eventName(gC)),this._isHovered===!1&&this._leave(),this._isHovered=!1};this._queueCallback(a,this.tip,this._isAnimated())}hide(){if(!this._isShown()||N.trigger(this._element,this.constructor.eventName(fC)).defaultPrevented)return;if(this._getTipElement().classList.remove(gi),"ontouchstart"in document.documentElement)for(const s of[].concat(...document.body.children))N.off(s,"mouseover",Zi);this._activeTrigger[fa]=!1,this._activeTrigger[da]=!1,this._activeTrigger[ns]=!1,this._isHovered=null;const r=()=>{this._isWithActiveTrigger()||(this._isHovered||this._disposePopper(),this._element.removeAttribute("aria-describedby"),N.trigger(this._element,this.constructor.eventName(pC)))};this._queueCallback(r,this.tip,this._isAnimated())}update(){this._popper&&this._popper.update()}_isWithContent(){return!!this._getTitle()}_getTipElement(){return this.tip||(this.tip=this._createTipElement(this._newContent||this._getContentForTemplate())),this.tip}_createTipElement(e){const t=this._getTemplateFactory(e).toHtml();if(!t)return null;t.classList.remove(ha,gi),t.classList.add(`bs-${this.constructor.NAME}-auto`);const r=dA(this.constructor.NAME).toString();return t.setAttribute("id",r),this._isAnimated()&&t.classList.add(ha),t}setContent(e){this._newContent=e,this._isShown()&&(this._disposePopper(),this.show())}_getTemplateFactory(e){return this._templateFactory?this._templateFactory.changeContent(e):this._templateFactory=new aC({...this._config,content:e,extraClass:this._resolvePossibleFunction(this._config.customClass)}),this._templateFactory}_getContentForTemplate(){return{[hC]:this._getTitle()}}_getTitle(){return this._resolvePossibleFunction(this._config.title)||this._element.getAttribute("data-bs-original-title")}_initializeOnDelegatedTarget(e){return this.constructor.getOrCreateInstance(e.delegateTarget,this._getDelegateConfig())}_isAnimated(){return this._config.animation||this.tip&&this.tip.classList.contains(ha)}_isShown(){return this.tip&&this.tip.classList.contains(gi)}_createPopper(e){const t=De(this._config.placement,[this,e,this._element]),r=IC[t.toUpperCase()];return Jc(this._element,e,this._getPopperConfig(r))}_getOffset(){const{offset:e}=this._config;return typeof e=="string"?e.split(",").map(t=>Number.parseInt(t,10)):typeof e=="function"?t=>e(t,this._element):e}_resolvePossibleFunction(e){return De(e,[this._element,this._element])}_getPopperConfig(e){const t={placement:e,modifiers:[{name:"flip",options:{fallbackPlacements:this._config.fallbackPlacements}},{name:"offset",options:{offset:this._getOffset()}},{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"arrow",options:{element:`.${this.constructor.NAME}-arrow`}},{name:"preSetPlacement",enabled:!0,phase:"beforeMain",fn:r=>{this._getTipElement().setAttribute("data-popper-placement",r.state.placement)}}]};return{...t,...De(this._config.popperConfig,[void 0,t])}}_setListeners(){const e=this._config.trigger.split(" ");for(const t of e)if(t==="click")N.on(this._element,this.constructor.eventName(yC),this._config.selector,r=>{const s=this._initializeOnDelegatedTarget(r);s._activeTrigger[fa]=!(s._isShown()&&s._activeTrigger[fa]),s.toggle()});else if(t!==dC){const r=t===ns?this.constructor.eventName(TC):this.constructor.eventName(EC),s=t===ns?this.constructor.eventName(wC):this.constructor.eventName(vC);N.on(this._element,r,this._config.selector,i=>{const a=this._initializeOnDelegatedTarget(i);a._activeTrigger[i.type==="focusin"?da:ns]=!0,a._enter()}),N.on(this._element,s,this._config.selector,i=>{const a=this._initializeOnDelegatedTarget(i);a._activeTrigger[i.type==="focusout"?da:ns]=a._element.contains(i.relatedTarget),a._leave()})}this._hideModalHandler=()=>{this._element&&this.hide()},N.on(this._element.closest(Kh),Gh,this._hideModalHandler)}_fixTitle(){const e=this._element.getAttribute("title");e&&(!this._element.getAttribute("aria-label")&&!this._element.textContent.trim()&&this._element.setAttribute("aria-label",e),this._element.setAttribute("data-bs-original-title",e),this._element.removeAttribute("title"))}_enter(){if(this._isShown()||this._isHovered){this._isHovered=!0;return}this._isHovered=!0,this._setTimeout(()=>{this._isHovered&&this.show()},this._config.delay.show)}_leave(){this._isWithActiveTrigger()||(this._isHovered=!1,this._setTimeout(()=>{this._isHovered||this.hide()},this._config.delay.hide))}_setTimeout(e,t){clearTimeout(this._timeout),this._timeout=setTimeout(e,t)}_isWithActiveTrigger(){return Object.values(this._activeTrigger).includes(!0)}_getConfig(e){const t=Tt.getDataAttributes(this._element);for(const r of Object.keys(t))lC.has(r)&&delete t[r];return e={...t,...typeof e=="object"&&e?e:{}},e=this._mergeConfigObj(e),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}_configAfterMerge(e){return e.container=e.container===!1?document.body:rn(e.container),typeof e.delay=="number"&&(e.delay={show:e.delay,hide:e.delay}),typeof e.title=="number"&&(e.title=e.title.toString()),typeof e.content=="number"&&(e.content=e.content.toString()),e}_getDelegateConfig(){const e={};for(const[t,r]of Object.entries(this._config))this.constructor.Default[t]!==r&&(e[t]=r);return e.selector=!1,e.trigger="manual",e}_disposePopper(){this._popper&&(this._popper.destroy(),this._popper=null),this.tip&&(this.tip.remove(),this.tip=null)}static jQueryInterface(e){return this.each(function(){const t=Vr.getOrCreateInstance(this,e);if(typeof e=="string"){if(typeof t[e]>"u")throw new TypeError(`No method named "${e}"`);t[e]()}})}}ze(Vr);const SC="popover",CC=".popover-header",RC=".popover-body",PC={...Vr.Default,content:"",offset:[0,8],placement:"right",template:'<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',trigger:"click"},NC={...Vr.DefaultType,content:"(null|string|element|function)"};class nl extends Vr{static get Default(){return PC}static get DefaultType(){return NC}static get NAME(){return SC}_isWithContent(){return this._getTitle()||this._getContent()}_getContentForTemplate(){return{[CC]:this._getTitle(),[RC]:this._getContent()}}_getContent(){return this._resolvePossibleFunction(this._config.content)}static jQueryInterface(e){return this.each(function(){const t=nl.getOrCreateInstance(this,e);if(typeof e=="string"){if(typeof t[e]>"u")throw new TypeError(`No method named "${e}"`);t[e]()}})}}ze(nl);const DC="scrollspy",OC="bs.scrollspy",rl=`.${OC}`,kC=".data-api",VC=`activate${rl}`,Yh=`click${rl}`,LC=`load${rl}${kC}`,MC="dropdown-item",Yn="active",xC='[data-bs-spy="scroll"]',pa="[href]",FC=".nav, .list-group",Qh=".nav-link",UC=".nav-item",$C=".list-group-item",BC=`${Qh}, ${UC} > ${Qh}, ${$C}`,jC=".dropdown",HC=".dropdown-toggle",qC={offset:null,rootMargin:"0px 0px -25%",smoothScroll:!1,target:null,threshold:[.1,.5,1]},WC={offset:"(number|null)",rootMargin:"string",smoothScroll:"boolean",target:"element",threshold:"array"};class bo extends Je{constructor(e,t){super(e,t),this._targetLinks=new Map,this._observableSections=new Map,this._rootElement=getComputedStyle(this._element).overflowY==="visible"?null:this._element,this._activeTarget=null,this._observer=null,this._previousScrollData={visibleEntryTop:0,parentScrollTop:0},this.refresh()}static get Default(){return qC}static get DefaultType(){return WC}static get NAME(){return DC}refresh(){this._initializeTargetsAndObservables(),this._maybeEnableSmoothScroll(),this._observer?this._observer.disconnect():this._observer=this._getNewObserver();for(const e of this._observableSections.values())this._observer.observe(e)}dispose(){this._observer.disconnect(),super.dispose()}_configAfterMerge(e){return e.target=rn(e.target)||document.body,e.rootMargin=e.offset?`${e.offset}px 0px -30%`:e.rootMargin,typeof e.threshold=="string"&&(e.threshold=e.threshold.split(",").map(t=>Number.parseFloat(t))),e}_maybeEnableSmoothScroll(){this._config.smoothScroll&&(N.off(this._config.target,Yh),N.on(this._config.target,Yh,pa,e=>{const t=this._observableSections.get(e.target.hash);if(t){e.preventDefault();const r=this._rootElement||window,s=t.offsetTop-this._element.offsetTop;if(r.scrollTo){r.scrollTo({top:s,behavior:"smooth"});return}r.scrollTop=s}}))}_getNewObserver(){const e={root:this._rootElement,threshold:this._config.threshold,rootMargin:this._config.rootMargin};return new IntersectionObserver(t=>this._observerCallback(t),e)}_observerCallback(e){const t=a=>this._targetLinks.get(`#${a.target.id}`),r=a=>{this._previousScrollData.visibleEntryTop=a.target.offsetTop,this._process(t(a))},s=(this._rootElement||document.documentElement).scrollTop,i=s>=this._previousScrollData.parentScrollTop;this._previousScrollData.parentScrollTop=s;for(const a of e){if(!a.isIntersecting){this._activeTarget=null,this._clearActiveClass(t(a));continue}const c=a.target.offsetTop>=this._previousScrollData.visibleEntryTop;if(i&&c){if(r(a),!s)return;continue}!i&&!c&&r(a)}}_initializeTargetsAndObservables(){this._targetLinks=new Map,this._observableSections=new Map;const e=F.find(pa,this._config.target);for(const t of e){if(!t.hash||sn(t))continue;const r=F.findOne(decodeURI(t.hash),this._element);Or(r)&&(this._targetLinks.set(decodeURI(t.hash),t),this._observableSections.set(t.hash,r))}}_process(e){this._activeTarget!==e&&(this._clearActiveClass(this._config.target),this._activeTarget=e,e.classList.add(Yn),this._activateParents(e),N.trigger(this._element,VC,{relatedTarget:e}))}_activateParents(e){if(e.classList.contains(MC)){F.findOne(HC,e.closest(jC)).classList.add(Yn);return}for(const t of F.parents(e,FC))for(const r of F.prev(t,BC))r.classList.add(Yn)}_clearActiveClass(e){e.classList.remove(Yn);const t=F.find(`${pa}.${Yn}`,e);for(const r of t)r.classList.remove(Yn)}static jQueryInterface(e){return this.each(function(){const t=bo.getOrCreateInstance(this,e);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e]()}})}}N.on(window,LC,()=>{for(const n of F.find(xC))bo.getOrCreateInstance(n)});ze(bo);const zC="tab",KC="bs.tab",xn=`.${KC}`,GC=`hide${xn}`,YC=`hidden${xn}`,QC=`show${xn}`,XC=`shown${xn}`,JC=`click${xn}`,ZC=`keydown${xn}`,eR=`load${xn}`,tR="ArrowLeft",Xh="ArrowRight",nR="ArrowUp",Jh="ArrowDown",ma="Home",Zh="End",vn="active",ed="fade",ga="show",rR="dropdown",Sm=".dropdown-toggle",sR=".dropdown-menu",_a=`:not(${Sm})`,iR='.list-group, .nav, [role="tablist"]',oR=".nav-item, .list-group-item",aR=`.nav-link${_a}, .list-group-item${_a}, [role="tab"]${_a}`,Cm='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',ya=`${aR}, ${Cm}`,cR=`.${vn}[data-bs-toggle="tab"], .${vn}[data-bs-toggle="pill"], .${vn}[data-bs-toggle="list"]`;class Ir extends Je{constructor(e){super(e),this._parent=this._element.closest(iR),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),N.on(this._element,ZC,t=>this._keydown(t)))}static get NAME(){return zC}show(){const e=this._element;if(this._elemIsActive(e))return;const t=this._getActiveElem(),r=t?N.trigger(t,GC,{relatedTarget:e}):null;N.trigger(e,QC,{relatedTarget:t}).defaultPrevented||r&&r.defaultPrevented||(this._deactivate(t,e),this._activate(e,t))}_activate(e,t){if(!e)return;e.classList.add(vn),this._activate(F.getElementFromSelector(e));const r=()=>{if(e.getAttribute("role")!=="tab"){e.classList.add(ga);return}e.removeAttribute("tabindex"),e.setAttribute("aria-selected",!0),this._toggleDropDown(e,!0),N.trigger(e,XC,{relatedTarget:t})};this._queueCallback(r,e,e.classList.contains(ed))}_deactivate(e,t){if(!e)return;e.classList.remove(vn),e.blur(),this._deactivate(F.getElementFromSelector(e));const r=()=>{if(e.getAttribute("role")!=="tab"){e.classList.remove(ga);return}e.setAttribute("aria-selected",!1),e.setAttribute("tabindex","-1"),this._toggleDropDown(e,!1),N.trigger(e,YC,{relatedTarget:t})};this._queueCallback(r,e,e.classList.contains(ed))}_keydown(e){if(![tR,Xh,nR,Jh,ma,Zh].includes(e.key))return;e.stopPropagation(),e.preventDefault();const t=this._getChildren().filter(s=>!sn(s));let r;if([ma,Zh].includes(e.key))r=t[e.key===ma?0:t.length-1];else{const s=[Xh,Jh].includes(e.key);r=Zc(t,e.target,s,!0)}r&&(r.focus({preventScroll:!0}),Ir.getOrCreateInstance(r).show())}_getChildren(){return F.find(ya,this._parent)}_getActiveElem(){return this._getChildren().find(e=>this._elemIsActive(e))||null}_setInitialAttributes(e,t){this._setAttributeIfNotExists(e,"role","tablist");for(const r of t)this._setInitialAttributesOnChild(r)}_setInitialAttributesOnChild(e){e=this._getInnerElement(e);const t=this._elemIsActive(e),r=this._getOuterElement(e);e.setAttribute("aria-selected",t),r!==e&&this._setAttributeIfNotExists(r,"role","presentation"),t||e.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(e,"role","tab"),this._setInitialAttributesOnTargetPanel(e)}_setInitialAttributesOnTargetPanel(e){const t=F.getElementFromSelector(e);t&&(this._setAttributeIfNotExists(t,"role","tabpanel"),e.id&&this._setAttributeIfNotExists(t,"aria-labelledby",`${e.id}`))}_toggleDropDown(e,t){const r=this._getOuterElement(e);if(!r.classList.contains(rR))return;const s=(i,a)=>{const c=F.findOne(i,r);c&&c.classList.toggle(a,t)};s(Sm,vn),s(sR,ga),r.setAttribute("aria-expanded",t)}_setAttributeIfNotExists(e,t,r){e.hasAttribute(t)||e.setAttribute(t,r)}_elemIsActive(e){return e.classList.contains(vn)}_getInnerElement(e){return e.matches(ya)?e:F.findOne(ya,e)}_getOuterElement(e){return e.closest(oR)||e}static jQueryInterface(e){return this.each(function(){const t=Ir.getOrCreateInstance(this);if(typeof e=="string"){if(t[e]===void 0||e.startsWith("_")||e==="constructor")throw new TypeError(`No method named "${e}"`);t[e]()}})}}N.on(document,JC,Cm,function(n){["A","AREA"].includes(this.tagName)&&n.preventDefault(),!sn(this)&&Ir.getOrCreateInstance(this).show()});N.on(window,eR,()=>{for(const n of F.find(cR))Ir.getOrCreateInstance(n)});ze(Ir);const lR="toast",uR="bs.toast",un=`.${uR}`,hR=`mouseover${un}`,dR=`mouseout${un}`,fR=`focusin${un}`,pR=`focusout${un}`,mR=`hide${un}`,gR=`hidden${un}`,_R=`show${un}`,yR=`shown${un}`,ER="fade",td="hide",_i="show",yi="showing",vR={animation:"boolean",autohide:"boolean",delay:"number"},TR={animation:!0,autohide:!0,delay:5e3};class So extends Je{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return TR}static get DefaultType(){return vR}static get NAME(){return lR}show(){if(N.trigger(this._element,_R).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(ER);const t=()=>{this._element.classList.remove(yi),N.trigger(this._element,yR),this._maybeScheduleHide()};this._element.classList.remove(td),Bs(this._element),this._element.classList.add(_i,yi),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown()||N.trigger(this._element,mR).defaultPrevented)return;const t=()=>{this._element.classList.add(td),this._element.classList.remove(yi,_i),N.trigger(this._element,gR)};this._element.classList.add(yi),this._queueCallback(t,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(_i),super.dispose()}isShown(){return this._element.classList.contains(_i)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout(()=>{this.hide()},this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":{this._hasMouseInteraction=t;break}case"focusin":case"focusout":{this._hasKeyboardInteraction=t;break}}if(t){this._clearTimeout();return}const r=e.relatedTarget;this._element===r||this._element.contains(r)||this._maybeScheduleHide()}_setListeners(){N.on(this._element,hR,e=>this._onInteraction(e,!0)),N.on(this._element,dR,e=>this._onInteraction(e,!1)),N.on(this._element,fR,e=>this._onInteraction(e,!0)),N.on(this._element,pR,e=>this._onInteraction(e,!1))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each(function(){const t=So.getOrCreateInstance(this,e);if(typeof e=="string"){if(typeof t[e]>"u")throw new TypeError(`No method named "${e}"`);t[e](this)}})}}wo(So);ze(So);console.log("app.js loaded");vI(async n=>{if(!n){const t=window.location.pathname.split("/").pop(),r=["template.html"],s=["login.html","index.html"];r.includes(t)?(alert("You're not supposed to be here...."),location.href="index.html"):s.includes(t)||(alert("You need to be signed in to view this page."),location.href="login.html");return}const e=await mI(pp(Cp,"users",n.uid));e.exists()?e.data().name:n.displayName||n.email});export{Cp as a,bR as b,pp as d,mI as g,IR as l,vI as o,AR as s};
